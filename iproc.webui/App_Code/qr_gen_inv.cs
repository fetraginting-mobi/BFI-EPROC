...
public class qr_gen_inv : System.Web.UI.Page
{
    public void QRGenInv(string input)
    {
        //qrlev(input.Length);
        try
        {
            ...
            String Path = Server.MapPath(@"..\..\temp\qrcodesinv\");
            //Path = "C:\\" + input + ".png";
    ...
    public String QRImageSave(String barcodes, int id)
    {
        ...
        {
            String Path; ;
            Path = Server.MapPath(@"..\temp\qrcodesinv\" + barcodes + DateTime.Now.ToString("yyyyMMddHHmmss") + ".png");
    ...
    private void ConvertPictureToByte(String barcode, String FileName, String path)
    {
        ...
        try
        {
            ...
            dal.Update("INVENTORY_BARCODE", parameters);
        }
        catch (Exception ex)
        {
            throw ex;
