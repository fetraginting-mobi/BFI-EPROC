...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function tab()
        {
            var btnAdd = document.getElementById('ctl00_cpb_btnAdd');
            var btnRemove = document.getElementById('ctl00_cpb_btnRemove');
    ...
    <section class="panel">
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <asp:LinkButton ID="btnAdd" runat="server" CssClass="btn btn-primary" OnClick="btnAdd_Click" OnClientClick="javascript:tab();" CausesValidation="false"><i class="icon-plus"></i>  Add</asp:LinkButton>
                    <asp:LinkButton ID="btnRemove" runat="server" CssClass="btn btn-primary" OnClick="btnRemove_Click" OnClientClick="javascript:tab();" CausesValidation="false"><i class="icon-minus"></i>  Remove</asp:LinkButton>
                </div>
            </div>
