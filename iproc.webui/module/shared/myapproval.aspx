<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="myapproval.aspx.cs" Inherits="module_shared_myapproval" %>
                ...
                <ContentTemplate>
                    <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="false" CssClass="display table table-bordered table-striped"
                        ...
                        <Columns>
                            <%--<asp:TemplateField>
                                <HeaderTemplate>
                                    <asp:CheckBox runat="server" ID="chbCheckedAll" onclick="checkAll(this)"/>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:CheckBox runat="server" ID="chbChecked" onclick="Check_Click(this)"/>
                                </ItemTemplate>
                            </asp:TemplateField>--%>
                            ...
                            <asp:BoundField DataField="BRANCH" HeaderText="Branch">
                              ...
                              <asp:TemplateField HeaderText="Remarks">
                                      <ItemStyle Width="50%" HorizontalAlign="Left" />
                                        <ItemTemplate>
                                            <cc1:XUITextBox runat="server" ID="txtRemarks" Enabled ="false"  Text='<%# Eval("DESCRIPTION") %>' TextMode="MultiLine" CssClass="form-control input-slider-info" >
                                            </cc1:XUITextBox> 
                                        </ItemTemplate>
                                    </asp:TemplateField> 
                           <%-- <asp:BoundField DataField="DESCRIPTION"  CssClass="form-control input-sm" HeaderText="Description">
                                <ItemStyle Width="50%" HorizontalAlign="left"/>
                            </asp:BoundField>--%>
                            <asp:BoundField DataField="REQUEST_DATE" HeaderText="Request Date" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}">
