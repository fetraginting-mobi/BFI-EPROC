...
public partial class module_commonmst_mastersupplierdocument : BasePage
{
    private static string TABLE_NAME = "SUPPLIER_DOCUMENT";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            lblCode.Text = Request.Params["suppliercode"];
    ...
    private void GetCode()
    {
        ...
        try
        {
            ...
            lblCode.Text = _dr["suppliercode"].ToString();
        }
        catch (Exception ex)
        {
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            sFileDirectorys = Server.MapPath("~/" + Shared.GetUploadPath("ADD_DOCUMENT/" + Request.Params["suppliercode"]));
            ...
            if (fupFilename.HasFile)
            {
                   ...
                   )
                {
                    ...
                    sFilePath = Shared.GetUploadPath("ADD_DOCUMENT/" + Request.Params["suppliercode"]) + sfullname;
                }
                else
                {
            ...
            Shared.ShowSuccessGritter(this, string.Format("mastersupplier.aspx?action=edit&suppliercode={0}", Request.Params["suppliercode"]));
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
    ...
    {
        Response.Redirect("mastersupplier.aspx?action=edit&suppliercode=" + Request.Params["suppliercode"]);
    }
}
