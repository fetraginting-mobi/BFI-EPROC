<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="masternotification.aspx.cs" Inherits="module_commonmst_masternotification" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">    
    <section class="panel">
        ...
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-12">
                    <cc1:XUILinkButton RoleCode="R20000040C" ID="btnSave" runat="server" CssClass="btn btn-primary" OnClick="btnSave_Click"><i class="icon-save"></i>  Save</cc1:XUILinkButton>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <cc1:XUITextBox ID="txtMessage" runat="server" CssClass="form-control" placeholder="Message" DBColumnName="MESSAGE" SPParameterName="p_message" MaxLength="1000" DataType="String" BindType="Both" TextMode="MultiLine" ></cc1:XUITextBox>
                                    <asp:RequiredFieldValidator ID="rfvMessage" runat="server" ErrorMessage="Required Field!" ControlToValidate="txtMessage" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>                            
                        </div>
                    </div>   
