...
public partial class module_commonmst_mastersupplierbank : BasePage
{
    ...
    {
        LoadInit();
        lblId.Text = Request.Params["id_dt"];
        ...
        if (!Page.IsPostBack)
        {
            ...
            {
                txtAccountName.Text = Request.Params["suppliername"];
            }
        }
        LoadAfterInit();
    }
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            if (Request.Params["action"].Equals("add"))
            {
                ...
                Shared.ShowSuccessGritter(this, string.Format("mastersupplierbank.aspx?action=edit&suppliercode={0}&id={1}&id_dt={2}", Request.Params["suppliercode"], Request.Params["id"], lblId.Text));
            }
