...
public partial class module_commonmst_faassetdetail : BasePage
{
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            //}
            Shared.ShowSuccessGritter(this, string.Format("faassetdetail.aspx?action=edit&id={0}&codebarcode={1}&faid={2}&assettype={3}", lblID.Text, Request.Params["codebarcode"], lblfaid.Text, Request.Params["assettype"]));
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("faasset.aspx?action=edit&id=" + lblfaid.Text + "&assetno=" + Request.Params["codebarcode"] + "&assettype=" + Request.Params["assettype"]);
    }  
}
