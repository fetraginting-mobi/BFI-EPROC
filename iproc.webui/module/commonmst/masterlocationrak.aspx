<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="masterlocationrak.aspx.cs" Inherits="module_commonmst_masterlocationrak" %>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <%--<div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <cc1:XUITextBox ID="txtLotCode" style="display:none" runat="server" CssClass="form-control" DBColumnName="LOT_CODE" SPParameterName="p_lot_code" MaxLength="10" DataType="String" BindType="Both"></cc1:XUITextBox>
                                <cc1:XUILabel ID="lblLotCode" runat="server" DBColumnName="LOT_NAME"  MaxLength="10" DataType="String" BindType="DBToUIOnly"></cc1:XUILabel>--%>
                            <div class="form-group">
                            <label class="col-sm-2">Lot Code</label>
                            <asp:RequiredFieldValidator ID="rfvCode" runat="server" ErrorMessage="*" ControlToValidate="txtLotCode" Display="Dynamic"></asp:RequiredFieldValidator>
                            <div class="col-sm-5">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Required Field!" ControlToValidate="txtLotCode" Display="Dynamic"></asp:RequiredFieldValidator>
                            </div>
                            </div>
                        </div>                            
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label class="col-sm-2">Rak Code</label>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="txtLotCode" Display="Dynamic"></asp:RequiredFieldValidator>
                            <div class="col-sm-5">
                                <%--<cc1:XUITextBox ID="txtLotCode" runat="server" CssClass="form-control" placeholder="Lot Code" DBColumnName="LOT_CODE" SPParameterName="p_lot_code" MaxLength="10" DataType="String" BindType="Both"></cc1:XUITextBox>--%>
