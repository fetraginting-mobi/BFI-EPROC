...
public partial class module_commonmst_mastermodel : BasePage
{
    private static string TABLE_NAME = "MASTER_MODEL";
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            Shared.ShowSuccessGritter(this, string.Format("mastermodellist.aspx"));
            //Shared.ShowSuccessGritter(this, string.Format("mastermodel.aspx?action=edit&code={0}", lblCode.Text));
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
    ...
    {
        Response.Redirect("mastermodellist.aspx");
    }
