<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="mastersupplierbank.aspx.cs" Inherits="module_commonmst_mastersupplierbank" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">    
    <section class="panel">
        <header class="panel-heading">
          <span>Bank Supplier Info</span>
        </header>
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-12">
                    <cc1:XUILinkButton RoleCode="R30000150E" ID="btnSave" runat="server" CssClass="btn btn-primary" OnClick="btnSave_Click"><i class="icon-save"></i>  Save</cc1:XUILinkButton>
        ...
        <div class="panel-body form-horizontal">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <cc1:XUILabel ID="lblId" runat="server" DBColumnName="ID" SPParameterName="p_id" BindType="DBToUIOnly" DataType="Integer" Text="0" Style="display:none"></cc1:XUILabel>
                    <div class="row">
                        <div class="col-sm-12">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12">
                            <div class="form-group">
                                <label class="col-sm-2">Bank Branch *</label>
                                <div class="col-sm-5">
                                    <cc1:XUITextBox ID="txtBankBranch" runat="server" CssClass="form-control" placeholder="Bank Branch" DBColumnName="BANK_BRANCH" SPParameterName="p_bank_branch" MaxLength="50" TextMode="MultiLine" DataType="String" BindType="Both" ></cc1:XUITextBox>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <cc1:XUITextBox ID="txtBankAccount" runat="server" CssClass="form-control" placeholder="Bank Account Nomor" DBColumnName="BANK_ACCOUNT_NO" SPParameterName="p_bank_account_no" MaxLength="50" DataType="String" BindType="Both" ></cc1:XUITextBox>
                                    ...
                                    <asp:RegularExpressionValidator ID="refBankAccount" runat="server" ErrorMessage="Format Invalid!" ControlToValidate="txtBankAccount" ValidationExpression="[0-9 .,/()]*[0-9 .,/()]" Display="Dynamic"></asp:RegularExpressionValidator> 
                                </div>
                            </div>                            
                        </div>
                    </div>
