<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="mastersupplierdocument.aspx.cs" Inherits="module_commonmst_mastersupplierdocument" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">   
    <section class="panel">
        ...
        <div class="panel-body form-horizontal">
                    ...
                    <cc1:XUILabel ID="lblSupplierCode" runat="server"  DBColumnName="SUPPLIER_CODE" SPParameterName="p_supplier_code" DataType="String" BindType="UIToDBOnly" MaxLength="14"  style = "Display:none;"></cc1:XUILabel>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <cc1:XUILabel ID="lblCode" runat="server" DBColumnName="SUPPLIER_CODE" DataType="String" BindType="DBToUIOnly"></cc1:XUILabel>
