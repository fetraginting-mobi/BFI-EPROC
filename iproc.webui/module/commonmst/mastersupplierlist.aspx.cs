...
public partial class module_commonmst_mastersupplierlist : BasePageList
{
    ...
    private void BindData()
    {
        ...
        try
        {
            ...
            _ht["p_type"] = ddlCreditorTypeCode.SelectedValue;
    ...
    protected void ddlCreditorTypeCode_SelectedIndexChanged(object sender, EventArgs e)
    {
        BindData();
    }
