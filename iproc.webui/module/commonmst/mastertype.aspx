<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true"
    CodeFile="mastertype.aspx.cs" Inherits="module_commonmst_mastertype" %>
       ...
       <div class="panel-body form-horizontal">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-sm-3">Type Name *</label>
                            <div class="col-sm-9">
                                <cc1:XUITextBox ID="txtTypeName" runat="server" CssClass="form-control" placeholder="Type Name" DBColumnName="TYPE_NAME" SPParameterName="p_type_name" MaxLength="100" DataType="String" BindType="Both"></cc1:XUITextBox>
