...
public partial class module_commonmst_faasset : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Request.Params["action"].Equals("edit"))
            {
                ...
                // (+) Ari 23-01-2023 ket : enhancement 2022, ketika dipakai oleh employee maka tampilkan employee nya
                if (lblUsedby.Text == "-")
                {
                    lblUsedby.Visible = false;
                    Used.Visible = false;
                }
                else
                {
                    lblUsedby.Visible = true;
                    Used.Visible = true;
                }
    ...
    {
        gvwListMain.PageIndex = e.NewPageIndex;
        BindDataaMaintenance();
    }

    protected void gvwListMain_OnRowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            dSubTotal = dSubTotal + decimal.Parse(e.Row.Cells[3].Text);
    ...
    {
        if (lblBarcode.Text != string.Empty)
        BindDataaMaintenance();
    }
    #endregion
