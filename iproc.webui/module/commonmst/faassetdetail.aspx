<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="faassetdetail.aspx.cs" Inherits="module_commonmst_faassetdetail" %>
           ...
           <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <cc1:XUITextBox ID="txtStartDate" runat="server" CssClass="form-control default-date-picker" placeholder="Policy Start Date" DBColumnName="POLICY_START_DATE" SPParameterName="p_policy_start_date"  DataType="DateTime" BindType="Both" Format="dd/MM/yyyy"></cc1:XUITextBox>
