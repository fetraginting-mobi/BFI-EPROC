<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="fagroup.aspx.cs" Inherits="module_commonmst_fagroup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">    
    <section class="panel">
        <header class="panel-heading">
          <span>FA Depre. Category Commercial Info</span>
        </header>
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-12">
                    <cc1:XUILinkButton RoleCode="90000040E" ID="btnSave" runat="server" CssClass="btn btn-primary" OnClick="btnSave_Click"><i class="icon-save"></i>  Save</cc1:XUILinkButton>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <cc1:XUITextBox ID="txtUsefull" runat="server" CssClass="form-control" placeholder="Usefull(Year)" DBColumnName="USEFULL" SPParameterName="p_usefull" DataType="Number" BindType="Both" MaxLength="2" Format="N2"></cc1:XUITextBox>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <cc1:XUITextBox ID="txtRate" runat="server" CssClass="form-control" placeholder="Rate(%)" DBColumnName="RATE" SPParameterName="p_rate" DataType="Number" BindType="Both" MaxLength="3" Format="N2"></cc1:XUITextBox>
                        ...
                        <div class="row" style="display:none">
                            <div class="col-sm-12">
                                <div class="form-group">
                                   ...
                                   <%-- <asp:RequiredFieldValidator ID="rfvtxtRND" runat="server" ErrorMessage="*" ControlToValidate="txtRND" Display="Dynamic"></asp:RequiredFieldValidator>--%>
                                    <div class="col-sm-3">
                                        <cc1:XUITextBox ID="txtRND" runat="server" CssClass="form-control" placeholder="Rounding" DBColumnName="ROUNDING" SPParameterName="p_rounding" DataType="Number" BindType="Both" MaxLength="18" Format="N2"></cc1:XUITextBox>
                                    </div>
                                </div>                            
                            </div>   
                         </div>          
