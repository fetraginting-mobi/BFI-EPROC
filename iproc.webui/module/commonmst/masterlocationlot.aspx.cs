...
public partial class module_commonmst_masterlocationlot : BasePage
{
    ...
    private void LoadData()
    {
        ...
        try
        {
            ...
            DataRow _dr = _dal.GetRow(TABLE_NAME_LOT, _ht);
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            {
                _dal.Insert(TABLE_NAME_LOT, _ht, ref iNextID);
                lblId.Text = iNextID.ToString();
            }
            else
                _dal.Update(TABLE_NAME_LOT, _ht);

            Shared.ShowSuccessGritter(this, string.Format("masterlocationlot.aspx?action=edit&warehousecode={0}&id={1}", txtWarehouseCode.Text, lblId.Text ));
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
