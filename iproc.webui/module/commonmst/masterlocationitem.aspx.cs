...
public partial class module_commonmst_masterlocationitem : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            btnLookUpInventoryRequestItem.Attributes["href"] = String.Format("javascript:fnShowDialog('../../lookup/generic.aspx?code=LFMIT&acol_0={0}&bcol_1={1}');", txtItemCode.ClientID, lblItemCode.ClientID);
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            {
                _dal.Insert(TABLE_NAME_ITEM, _ht, ref iNextID);
