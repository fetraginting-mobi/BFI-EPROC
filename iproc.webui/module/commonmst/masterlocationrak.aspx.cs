...
public partial class module_commonmst_masterlocationrak : BasePage
{
    ...
    private void LoadData()
    {
        ...
        try
        {
            ...
            DataRow _dr = _dal.GetRow(TABLE_NAME_RAK, _ht);
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            {
                _dal.Insert(TABLE_NAME_RAK, _ht, ref iNextID);
                lblId.Text = iNextID.ToString();
            }
            else
                _dal.Update(TABLE_NAME_RAK, _ht);
