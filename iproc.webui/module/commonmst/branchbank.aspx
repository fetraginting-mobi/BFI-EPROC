<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="branchbank.aspx.cs" Inherits="module_commonmst_branchbank" Title="Branch Bank" %>
        ...
        <div class="panel-body form-horizontal">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <cc1:XUILabel ID="lblCode" runat="server" DBColumnName="CODE" SPParameterName="p_code" BindType="Both" DataType="String" Text="0" Style="display:none"></cc1:XUILabel>
                    <div class="row">
                        <div class="col-sm-12">
                   ...
                   <div class="row">
                      <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <cc1:XUITextBox ID="txtBankBranch" runat="server" CssClass="form-control" placeholder="Bank Branch" DBColumnName="BANK_BRANCH" SPParameterName="p_bank_branch" MaxLength="4000" DataType="String" BindType="Both" TextMode="MultiLine" ></cc1:XUITextBox>
                    ...
                    <%--<div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <cc1:XUIDropDownList ID="ddlTypeFlag" runat="server" CssClass="form-control" DBColumnName="TYPE_FLAG" SPParameterName="p_type_flag" BindType="Both" DataType="String" AutoPostBack="true" OnSelectedIndexChanged="ddlTypeFlag_SelectedOnChanged" >
                                        <asp:ListItem Value="1">Bank</asp:ListItem>
                                        <asp:ListItem Value="2">Kas Besar</asp:ListItem>
                                        <asp:ListItem Value="3">Kas Kecil</asp:ListItem>
                                    </cc1:XUIDropDownList>
                                </div>
                            </div>                            
                       </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="col-sm-2">Acc No. *</label>
                                <div class="col-sm-5">
