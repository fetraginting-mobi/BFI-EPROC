<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="invlocationlist.aspx.cs" Inherits="module_commonmst_invlocationlist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">    
    <section class="panel">
        <header class="panel-heading">
          <span> Inventory Location List </span>
        </header>
                ...
                <ContentTemplate>
                    ...
                    AllowPaging="true" PageSize="10" DataKeyNames="ID"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="LOCATION_CODE" HeaderText="Code">
