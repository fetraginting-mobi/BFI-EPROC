...
public partial class module_commonpolicy_masterunits : BasePage
{
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            Shared.ShowSuccessGritter(this, string.Format("masterunitslist.aspx"));
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex); ;
    ...
    {
        Response.Redirect("masterunitslist.aspx");
    }
}
