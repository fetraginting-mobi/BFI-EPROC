...
public partial class module_apinvoice_appaymentrequestheader : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (Request.Params["action"].Equals("edit"))
            {
               ...
               // btnCancel.Text = "Back";
                ...
                if (lblTransFlagCode.Text == "POST" || lblTransFlagCode.Text == "CANCEL" || lblTransFlagCode.Text == "PAID")
                {
                    ...
                    //ddlBankDestination.Enabled = false;
            ...
            if (lblFlag.Text == "ADVANCE ENTRY")
            {
                btnAdd.Visible = btnDelete.Visible = false;
            }
            else if (lblFlag.Text == "DEPOSIT ENTRY")
            {
                btnAdd.Visible = btnDelete.Visible = false;
            }
            else
        ...
        Session[SessionKey.CURRENT_NEXT_URL_SESSION_KEY] = "../module/apinvoice/appaymentrequestheaderlist.aspx";


        btnPost.Attributes["href"] = String.Format("javascript:fnShowApprovalWithCommentDialog('../../approval/genericapplication.aspx?code=AP000036&parc_object_id={0}&nexturl={1}&status={2}&parc_object_branch={3}&parc_object_amount={4}&parc_branch_code={5}&parc_object_description={6}&parc_object_code={7}');", lblCodeBarcode.ClientID, Session[SessionKey.CURRENT_NEXT_URL_SESSION_KEY], "PROCESSED", lblbranch.ClientID, lblAmount.ClientID, lblbranch.ClientID, txtRemarks.ClientID, lblCode.ClientID);
       // btnPost.Attributes["href"] = String.Format("javascript:fnShowApprovalDialog('../../approval/generic.aspx?code=AP000036&parc_object_id={0}&parc_object_branch={1}');", lblCodeBarcode.ClientID, lblbranch.ClientID);
        ...
        btnReject.Attributes["href"] = String.Format("javascript:fnShowApprovalDialog('../../approval/generic.aspx?code=AP000043&parc_object_id={0}&parc_object_branch={1}');", lblCodeBarcode.ClientID, lblbranch.ClientID);
        LoadAfterInit();
    }
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            Shared.ShowSuccessGritter(this, string.Format("appaymentrequestheader.aspx?action=edit&codebarcode={0}", lblCodeBarcode.Text));
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
    ...
    private void PostData()
    {
        ...
        try
        {
            ...
            _dal.ExecRawSP("xsp_ap_payment_request_header_post", _ht);
    ...
    private void CancelData()
    {
        ...
        try
        {
            ...
            _dal.ExecRawSP("xsp_ap_payment_request_header_cancel", _ht);
    ...
    {
        Response.Redirect("appaymentrequestheaderlist.aspx");
    }
    ...
    {
        Response.Redirect("appaymentrequestdetail.aspx?action=add&codebarcode=" + lblCodeBarcode.Text + "&flag=" + txtFlag.Text);
    }
    ...
    {
        Response.Redirect(string.Format("appaymentrequestdetail.aspx?action=edit&id={0}&codebarcode={1}&divisioncode={2}&departmentcode={3}", gvwList.SelectedDataKey[0].ToString(), lblCodeBarcode.Text, ddlDivision.SelectedValue, ddlDepartment.SelectedValue));
    }
