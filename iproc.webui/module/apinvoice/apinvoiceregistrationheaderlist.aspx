<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="apinvoiceregistrationheaderlist.aspx.cs" Inherits="module_apinvoice_apinvoiceregistrationheaderlist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">    
    <section class="panel">
        <header class="panel-heading">
          <span>Invoice Registration List</span>
        </header>
         ...
         <div class="row">
            ...
            <asp:UpdatePanel ID="upd" runat="server">
                    ...
                    AllowPaging="true" PageSize="10" DataKeyNames="CODE_BARCODE"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="SUPPLIER_NAME" HeaderText="Supplier">
                             ...
                             <asp:BoundField DataField="reff_no" HeaderText="PO No.">
                                <ItemStyle Width="15%" />
                            </asp:BoundField>
                ...
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="btnDeleteAPInvoiceRegHeader" EventName="Click" />
                    <asp:AsyncPostBackTrigger ControlID="btnAddAPInvoiceRegHeader" EventName="Click" />
                </Triggers>
            </asp:UpdatePanel>
        </div>
    </section> 
