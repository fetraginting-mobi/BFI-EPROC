<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="invoicedocument.aspx.cs" Inherits="module_apinvoice_invoicedocument" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
 <section class="panel">
        <header class="panel-heading">
          <span>Upload Document Info</span>
        </header>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-3">Invoice Code.</label>
                                <div class="col-sm-5">
                                    <cc1:XUILabel ID="lblInvoiceCode" runat="server" DBColumnName="INVOICE_CODE" DataType="String" BindType="DBToUIOnly"></cc1:XUILabel>
                                   </div>
                                </div>
                            </div>                            
                        </div>
