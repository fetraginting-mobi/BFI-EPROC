<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="apadvanceallocationadvance.aspx.cs" Inherits="module_apinvoice_apadvanceallocationadvance" %>
        ...
        <div class="panel-body form-horizontal"> 
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <!--EMP_CODE-->
                    <cc1:XUITextBox ID="txtEmpCode"  runat="server" CssClass="form-control" DBColumnName="EMP_CODE" MaxLength="14" DataType="String" style="display:none;"  BindType="DBToUIOnly"></cc1:XUITextBox>
                    <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <label class="col-sm-4">Advance No. *</label>
                                <div class="col-sm-8">
                                    ...
                                    <cc1:XUITextBox ID="txtAdvanceNo" style="display:none" runat="server" CssClass="form-control" DBColumnName="AP_CODE" SPParameterName="p_ap_code" MaxLength="14" DataType="String" BindType="Both"></cc1:XUITextBox>
                                    <cc1:XUILabel ID="lblAdvanceDesc"  runat="server"  DBColumnName="CODE" DataType="String" BindType="DBToUIOnly" Text="--"></cc1:XUILabel>  
                                    <asp:RequiredFieldValidator ID="rfvInvoiceNo" runat="server" ErrorMessage="Required Field!" ControlToValidate="txtAdvanceNo" Display="Dynamic"></asp:RequiredFieldValidator>  
                                 </div>
                             </div>                            
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                            <label class="col-sm-4 ">Advance Date</label>
                                <div class="col-sm-4">
                                    <cc1:XUILabel ID="lblAdvanceDate" runat="server" placeholder="Invoice Date" DBColumnName="ADVANCE_DATE" DataType="DateTime" BindType="DBToUIOnly" Format ="dd/MM/yyyy"></cc1:XUILabel>
                                </div>
                            </div>                            
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                            <label class="col-sm-4">Advance Amount</label>
                                <div class="col-sm-5">
                                    ...
                                    <cc1:XUILabel ID="lblCurrencyDesc" style="display:none" runat="server" CssClass="form-control" placeholder="Currency Desc" DBColumnName="CURRENCY_CODE"  MaxLength="50" DataType="String" BindType="DBToUIOnly"></cc1:XUILabel>   
                                </div>
                             </div>                            
                         </div>
                         <div class="col-sm-6">
