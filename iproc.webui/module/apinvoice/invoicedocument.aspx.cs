...
public partial class module_apinvoice_invoicedocument : BasePage
{

    private static string TABLE_NAME = "INVOICE_DOCUMENT";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            lblInvoiceCode.Text = Request.Params["code"];
    ...
    private void GetCode()
    {
        ...
        try
        {
            ...
            _ht["p_invoice_code"] = lblCode.Text;
            _ht["p_id"] = Request.Params["id"];

            DataRow _dr = _dal.GetRow("INVOICE_DOCUMENT", _ht);
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            Shared.ShowSuccessGritter(this, string.Format("apinvoiceregistrationheader.aspx?action=edit&codebarcode={0}", Request.Params["codebarcode"]));
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
    ...
    {
        Response.Redirect("apinvoiceregistrationheader.aspx?action=edit&codebarcode=" + Request.Params["codebarcode"]);
    }
}