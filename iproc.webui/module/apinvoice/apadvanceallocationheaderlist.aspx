<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="apadvanceallocationheaderlist.aspx.cs" Inherits="module_apinvoice_apadvanceallocationheaderlist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">    
    <section class="panel">
        ...
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8">
                    <cc1:XUILinkButton ID="btnAddAPAdvanceAllocationHeader" RoleCode="R80000070C" runat="server" CssClass="btn btn-primary" OnClick="btnAddAPAdvanceAllocationHeader_Click" ><i class="icon-plus"></i>  Create</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnDeleteAPAdvanceAllocationHeader" RoleCode="R80000070D" runat="server" CssClass="btn btn-danger" OnClick="btnDeleteAPAdvanceAllocationHeader_Click" ><i class="icon-trash"></i>  Delete</cc1:XUILinkButton>
                </div>
                <div class="col-sm-4"> 
        ...
        <div class="panel-body">
            ...
            <asp:UpdatePanel ID="upd" runat="server">
                <ContentTemplate>
                    ...
                    AllowPaging="true" PageSize="10" DataKeyNames="CODE_BARCODE"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CODE" HeaderText="Advance Allocation No.">
                                <ItemStyle Width="20%" HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="USER_REQUEST" HeaderText="User Request">
                                <ItemStyle Width="15%" />
                            </asp:BoundField>
                ...
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="btnDeleteAPAdvanceAllocationHeader" EventName="Click" />
                    <asp:AsyncPostBackTrigger ControlID="btnAddAPAdvanceAllocationHeader" EventName="Click" />
                </Triggers>
            </asp:UpdatePanel>
        </div>
    </section> 
