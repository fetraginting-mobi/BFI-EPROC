...
public partial class module_apadvanceanddeposit_depositdocument : BasePage
{
    private static string TABLE_NAME = "DEPOSIT_DOCUMENT";
    ...
    private void GetCode()
    {
        ...
        try
        {
            ...
            DataRow _dr = _dal.GetRow("DEPOSIT_REGISTRATION", _ht);
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            _ht["p_deposit_code"] = Request.Params["codebarcode"];
            ...
            Shared.ShowSuccessGritter(this, string.Format("apdepositregistration.aspx?action=edit&codebarcode={0}", Request.Params["codebarcode"]));
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
    ...
    {
        Response.Redirect("apdepositregistration.aspx?action=edit&codebarcode=" + Request.Params["codebarcode"]);
    }
