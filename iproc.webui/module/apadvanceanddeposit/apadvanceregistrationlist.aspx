<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="apadvanceregistrationlist.aspx.cs" Inherits="module_apadvanceanddeposit_apadvanceregistrationlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">    
    <section class="panel">
        <header class="panel-heading">
          <span>Advance Registration List</span>
        </header>
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8">
                    <cc1:XUILinkButton ID="btnAdd" RoleCode="R80000040C" runat="server" CssClass="btn btn-primary" OnClick="btnAdd_Click" style="display:none;"><i class="icon-plus"></i>  Create</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnDelete" RoleCode="R80000040D" runat="server" CssClass="btn btn-danger" OnClick="btnDelete_Click"><i class="icon-trash"></i>  Delete</cc1:XUILinkButton>
                </div>
                <div class="col-sm-4">
                ...
                <ContentTemplate>
                    ...
                    AllowPaging="true" PageSize="10" DataKeyNames="CODE_BARCODE"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CURRENCY_NAME" HeaderText="">
