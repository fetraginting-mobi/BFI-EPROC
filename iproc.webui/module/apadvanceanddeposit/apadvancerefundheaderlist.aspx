<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="apadvancerefundheaderlist.aspx.cs" Inherits="module_apadvanceanddeposit_apadvancerefundheaderlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">    
    <section class="panel">
        <header class="panel-heading">
          <span>Advance Refund List</span>
        </header>
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8">
                    <cc1:XUILinkButton ID="btnAdd" runat="server"  RoleCode="R80000100C" CssClass="btn btn-primary" OnClick="btnAdd_Click"><i class="icon-plus"></i>  Create</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnDelete" RoleCode="R80000100D" runat="server" CssClass="btn btn-danger" OnClick="btnDelete_Click"><i class="icon-trash"></i>  Delete</cc1:XUILinkButton>
                </div>
                <div class="col-sm-4"> 
                ...
                <ContentTemplate>
                    ...
                    AllowPaging="true" PageSize="10" DataKeyNames="CODE_BARCODE"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CODE" HeaderText="Advance Refund No.">
                                <ItemStyle Width="15%" HorizontalAlign="Center"  />
                            </asp:BoundField>
                            <asp:BoundField DataField="JURNALID" HeaderText="Jurnal ID">
                                <ItemStyle Width="15%" HorizontalAlign="Center"  />
                            </asp:BoundField>
                            <asp:BoundField DataField="USER_REQUEST" HeaderText="Receive From">
