...
public partial class module_apadvanceanddeposit_apadvanceregistrationdetail : BasePage
{
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            Shared.ShowSuccessGritter(this, string.Format("apadvanceregistrationdetail.aspx?action=edit&id={0}&codebarcode={1}", lblId.Text, lblBarcode.Text));          
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
