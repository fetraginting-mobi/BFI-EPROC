<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="depositdocument.aspx.cs" Inherits="module_apadvanceanddeposit_depositdocument" Title="Untitled Page" %>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-3">Deposit Code.</label>
                                <div class="col-sm-5">
                                    <cc1:XUILabel ID="lblCode" runat="server" DBColumnName="DEPOSIT_CODE" DataType="String" BindType="DBToUIOnly"></cc1:XUILabel>
