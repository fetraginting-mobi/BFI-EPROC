<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="farequestmutationheader.aspx.cs" Inherits="module_fa_farequestmutationheader" Title="Untitled Page" %>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <cc1:XUILabel ID="lblCode" runat="server" DBColumnName="CODE" DataType="String" BindType="DBToUIOnly" Text="--"></cc1:XUILabel>
                                     <cc1:XUITextBox ID="txtBranch" runat="server" DBColumnName="CODE_BARCODE" SPParameterName="p_code_barcode" MaxLength="14" DataType="String"  BindType="None" style="display:none;" ></cc1:XUITextBox> 
                                     <cc1:XUITextBox ID="txtBranchRequest" runat="server" CssClass="form-control" placeholder="Ref No." DBColumnName="BRANCH_REQ" style="display:none;" SPParameterName="p_branch_req" MaxLength="20" DataType="String" BindType="Both"></cc1:XUITextBox>
                                </div>
                            </div>                            
                        </div>
                        <div class="col-sm-6">
                     ...
                     <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvFromLocation" runat="server" ControlToValidate="ddlFromLocationCode" ErrorMessage="Value Required!" InitialValue="0"></asp:RequiredFieldValidator>                                                 
                                </div>
                            </div>                            
                        </div>
                         <div class="col-sm-6">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <cc1:XUIDropDownList ID="ddlTocc" runat="server" CssClass="form-control" DBColumnName="BRANCH_CODE" SPParameterName="p_to_cost_center" DataType="String" OnSelectedIndexChanged= "ddlToBranch_SelectedIndexChanged" AutoPostBack= "true" BindType="Both" ></cc1:XUIDropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Required Field!" ControlToValidate="ddlTocc" InitialValue="0" Display="Dynamic"></asp:RequiredFieldValidator> 
                                </div>
                            </div>                             
                        </div> 
                         <div class="col-sm-6">
                     ...
                     <div class="row">
                         <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <cc1:XUITextBox ID="txtRemarksUnpost" runat="server" CssClass="form-control" placeholder="Remarks" ForeColor="Red" DBColumnName="REMARK_UNPOST" MaxLength="400" Enabled="false" Height="58px" TextMode="MultiLine" DataType="String" BindType="DBToUIOnly"></cc1:XUITextBox>
                                </div>
                            </div>                            
                         </div>
                        <div class="col-sm-6">
                        ...
                        <Columns>
                           ...
                           <asp:BoundField DataField="ITEM_NAME" HeaderText="Asset Name">
                            ...
                            <asp:BoundField DataField="ITEM_DESCRIPTION" HeaderText="Description">
                             ...
                             <asp:BoundField DataField="RECEIVE_DATE" HeaderText="Receive Date" DataFormatString="{0:dd/MM/yyyy}">
                                <ItemStyle Width="10%" HorizontalAlign="Center"  />
                            </asp:BoundField>
                             <asp:BoundField DataField="STATUS_RECEIVED" HeaderText="Status Mutation">
                                <ItemStyle Width="20%" HorizontalAlign="Left" />
                            </asp:BoundField>
