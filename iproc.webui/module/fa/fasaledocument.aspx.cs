...
public partial class module_fa_fasaledocument : BasePage
{

    private static string TABLE_NAME = "FA_SALE_DOCUMENT";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            lblFaSaleCode.Text = Request.Params["codebarcode"];
    ...
    private void GetCode()
    {
        ...
        try
        {
            ...
            lblFaSaleCode.Text = _dr["code"].ToString();
        }
        catch (Exception ex)
        {
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            _ht["p_fa_code"] = Request.Params["facode"];
            ...
            Shared.ShowSuccessGritter(this, string.Format("fasaledetail.aspx?action=edit&id={0}&codebarcode={1}", Request.Params["iddetail"], Request.Params["facode"]));
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
    ...
    {
        Response.Redirect("fasaledetail.aspx?action=edit&id=" + Request.Params["iddetail"] + "&codebarcode=" + Request.Params["facode"]);
    }
}
