<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="faassetmaintenancelist.aspx.cs" Inherits="module_fa_faassetmaintenancelist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">    
    <section class="panel">
        <header class="panel-heading">
          <span>FA Asset Maintenance List</span>
        </header>
                       ...
                       <Columns>
                        <asp:TemplateField>
                            ...
                            <asp:BoundField DataField="ITEM_NAME" HeaderText="Asset Name">
                              ...
                              <asp:BoundField DataField="BRANCH_DESC" HeaderText="Cost Center">
                                <ItemStyle Width="10%" HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="TRX_STATUS" HeaderText="Status">
                                <ItemStyle Width="20%" HorizontalAlign="Center" />
                            </asp:BoundField>
