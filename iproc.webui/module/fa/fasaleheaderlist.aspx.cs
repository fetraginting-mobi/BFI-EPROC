...
public partial class module_fa_fasaleheaderlist : BasePageList
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            Shared.BindGeneralSubCodeByTransflagCode(ddlStatus, "FS");
            Shared.BindBranchEmployeeSort(ddlBranch);

            BindData();
            btnDeleteSaleHeader.OnClientClick = "return confirm('Delete selected data?');";
        }
        LoadAfterInit();
    }
    ...
    protected void btnAddSaleHeader_Click(object sender, EventArgs e)
    {
        Response.Redirect("fasaleheader.aspx?action=add");
    }

    protected void btnDeleteSaleHeader_Click(object sender, EventArgs e)
    {
