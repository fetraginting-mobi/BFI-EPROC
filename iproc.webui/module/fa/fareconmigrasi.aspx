<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="fareconmigrasi.aspx.cs" Inherits="module_fa_fareconmigrasi" Title="Untitled Page" %>
        ...
        <header class="panel-heading">
          <span>FA Asset Info</span>
            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col-sm-12">
                        <cc1:XUILinkButton RoleCode="R90000065E" ID="btnSave" runat="server" CssClass="btn btn-primary" OnClick="btnSave_Click"><i class="icon-save"></i>  Save</cc1:XUILinkButton>
                        <cc1:XUILinkButton RoleCode="R90000065O" ID="btnGenerate" runat="server" CssClass="btn btn-primary" ValidationGroup="Header" OnClick="btnGenerate_Click"><i class="icon-save"></i>  Generate</cc1:XUILinkButton>
                    ...
                    <ContentTemplate>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <cc1:XUILabel ID="lblCostPrice" runat="server" DBColumnName="COST_PRICE" DataType="Number" BindType="DBToUIOnly" Format = "N2" style="display:none;"></cc1:XUILabel>
                                        <cc1:XUITextBox ID="txtCostPrice"  runat="server" CssClass="form-control" DBColumnName="COST_PRICE" SPParameterName="p_cost_price" Format="N2" MaxLength="10" DataType="Number" BindType="Both"></cc1:XUITextBox>
                                    </div>
                                </div>                            
                            </div> 
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <cc1:XUILabel ID="lblOrigPrice" runat="server"  DBColumnName="ORIG_PRICE"  DataType="Number" BindType="DBToUIOnly" Format = "N2" style="display:none;"></cc1:XUILabel>
                                          <cc1:XUITextBox ID="txtOrigPrice"  runat="server" CssClass="form-control" DBColumnName="ORIG_PRICE" SPParameterName="p_orig_price" Format="N2" MaxLength="10" DataType="Number" BindType="Both"></cc1:XUITextBox>
                                    </div>
                                </div>                            
                            </div>   
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="col-sm-4 "></label>
                                    <div class="col-sm-8">
                                        <asp:LinkButton runat="server" ID="btnLookUpUserRequest" style="display:none" class="btn btn-primary" data-toggle="modal" CausesValidation="false"><i class="icon-table"></i></asp:LinkButton>
                                        ...
                                        <cc1:XUILabel ID="lblSupplierName" runat="server" style="display:none" DBColumnName="EMP_NAME" DataType="String" BindType="DBToUIOnly" Text="--"></cc1:XUILabel>                       
                                    </div>
                                 </div>                            
                             </div>
                            <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <cc1:XUIDropDownList ID="ddlDepreCategoryBook" runat="server" CssClass="form-control" DBColumnName="CAT_CODE_BOOK" SPParameterName="p_cat_code_book" DataType="String" BindType="Both"></cc1:XUIDropDownList>
                                </div>
                            </div>                            
                        </div> 
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <cc1:XUIDropDownList ID="ddlDepreCategoryFiscal" runat="server" CssClass="form-control" DBColumnName="CAT_CODE_FISCAL" SPParameterName="p_cat_code_fiscal" DataType="String" BindType="Both"></cc1:XUIDropDownList>
                                </div>
                            </div>                            
                        </div>
                    </div>
      ...
      <div class="tab-pane" id="Depreciation">
       ...
       <div class="panel-body"> 
        ...
        <div class="row">
                ...
                <div class="input-group-btn">
                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-info" OnClick="btnSearch_Click"><i class="icon-search"></i>  Search</asp:LinkButton>
                </div>
                    </asp:Panel>
                </div>
            </div>
                    ...
                    AllowPaging="true" PageSize="10" DataKeyNames="ID"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="VENDOR_BY" HeaderText="Vendor By">
                              ...
                              <asp:BoundField DataField="LAST_KM" HeaderText="Last Kilometer">
                                <ItemStyle Width="10%" HorizontalAlign="Center"/>
                            </asp:BoundField>
