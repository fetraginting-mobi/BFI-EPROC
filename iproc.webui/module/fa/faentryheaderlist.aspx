<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="faentryheaderlist.aspx.cs" Inherits="module_fa_faentryheaderlist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">    
    <section class="panel">
        <header class="panel-heading">
          <span>Fixed Asset Entry List</span>
        </header>
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8">
                    <cc1:XUILinkButton ID="btnAddEntryHeader" RoleCode="R90000070C" runat="server" CssClass="btn btn-primary" OnClick="btnAddEntryHeader_Click" ><i class="icon-plus"></i>  Create</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnDeleteEntryHeader" RoleCode="R90000070D" runat="server" CssClass="btn btn-danger" OnClick="btnDeleteEntryHeader_Click" ><i class="icon-trash"></i>  Delete</cc1:XUILinkButton>
                </div>
                <div class="col-sm-4"> 
