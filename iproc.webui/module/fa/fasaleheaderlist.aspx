<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="fasaleheaderlist.aspx.cs" Inherits="module_fa_fasaleheaderlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">    
    <section class="panel">
        <header class="panel-heading">
          <span>Fixed Asset Sale List</span>
        </header>
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8">
                    <cc1:XUILinkButton ID="btnAddSaleHeader" RoleCode="R90000100C" runat="server" CssClass="btn btn-primary" OnClick="btnAddSaleHeader_Click" ><i class="icon-plus"></i>  Create</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnDeleteSaleHeader" RoleCode="R90000100D" runat="server" CssClass="btn btn-danger" OnClick="btnDeleteSaleHeader_Click" ><i class="icon-trash"></i>  Delete</cc1:XUILinkButton>
                </div>
                <div class="col-sm-4"> 
        ...
        <div class="panel-body">
             <div class="row">
                ...
                <%-- Kenny 12/06/2018 Add ddl Paid Status--%>
                <div class="col-sm-4">
                    <div class="form-group">
                    <label class="col-sm-3">Paid Status</label>
                        <div class="col-sm-5">
                          <cc1:XUIDropDownList ID="ddlPaidStatus" runat="server" CssClass="form-control" DBColumnName="PAID_STATUS" SPParameterName="p_paid_status" DataType="String" BindType="Both" AutoPostBack="true" OnSelectedIndexChanged="ddlPaidStatus_SelectedIndexChanged" >
            ...
            <asp:UpdatePanel ID="upd" runat="server">
                    ...
                    AllowPaging="true" PageSize="10" DataKeyNames="CODE_BARCODE"
                        ...
                        <Columns>
                          ...
                          <asp:TemplateField>
                              ...
                              <asp:BoundField DataField="JURNAL_ID" HeaderText="Jurnal ID">
                                <ItemStyle Width="10%" />
                            </asp:BoundField> 
                            <asp:BoundField DataField="SALE_DATE" HeaderText="Date"  DataFormatString="{0:dd/MM/yyyy}">
                                <ItemStyle Width="12%" HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="FROM_DESCRIPTION" HeaderText="Cost Center">
                            ...
                            <asp:BoundField DataField="PAID_STATUS" HeaderText="Paid Status">
                                <ItemStyle Width="8%" HorizontalAlign="Center"  />
                            </asp:BoundField>
                ...
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="btnDeleteSaleHeader" EventName="Click" />
                </Triggers>
            </asp:UpdatePanel>
        </div>
    </section> 
