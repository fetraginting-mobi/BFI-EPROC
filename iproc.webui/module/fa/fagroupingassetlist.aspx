<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="fagroupingassetlist.aspx.cs"
    Inherits="module_fa_fagroupingassetlist" Title="Untitled Page" %>
            ...
            <section class="panel">
                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <asp:Panel ID="pnlFaGroupSearch" runat="server" DefaultButton="btnFaGroupSearch"
                                class="input-group">
                                <asp:TextBox ID="txtFaGroupSearch" runat="server" CssClass="form-control"
                                    placeholder="Keywords"></asp:TextBox>
                                <div class="input-group-btn">
                                    <asp:LinkButton ID="btnFaGroupSearch" runat="server" CssClass="btn btn-info"
                                        OnClick="btnFaGroupSearch_Click"><i class="icon-search"></i> Search
                                    </asp:LinkButton>
                                </div>
                            </asp:Panel>
                        </div>
                ...
                <div class="panel-body">
                    ...
                    <asp:UpdatePanel ID="upd" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="gvwListFaGroupingAsset" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <asp:Label runat="server" ID="lblHeader" Text="Asset Group Code">
                                            </asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblGroupCode"
                                                Text='<%# Eval("ASSET_GROUP_CODE") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField>
                                        <HeaderTemplate>
                                            <asp:Label runat="server" ID="lblAssetGroupName" Text="Asset Group Name">
                                            </asp:Label>
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblAssetGroupName"
                                                Text='<%# Eval("ASSET_GROUP_NAME") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
