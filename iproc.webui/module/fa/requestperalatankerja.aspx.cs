...
public partial class module_fa_requestperalatankerja : BasePage
{
    private static string TABLE_NAME_HEADER = "REQUEST_PERALATAN_KERJA_HEADER";
    private static string TABLE_NAME_DETAIL = "REQUEST_PERALATAN_KERJA_DETAIL";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       ...
       // btnPost.Attributes["href"] = String.Format("javascript:fnShowApprovalWithCommentDialog('../../approval/genericapplication.aspx?code=AP000033&parc_object_id={0}&nexturl={1}&status={2}&parc_object_branch={3}&parc_object_code={4}');", lblCodeBarcode.ClientID, Session[SessionKey.CURRENT_NEXT_URL_SESSION_KEY], "VERIFI", lblBranchCode.ClientID, lblCode.ClientID);
        ...
        //btnLookUpStaff.Attributes["href"] = String.Format("javascript:fnShowDialog('../../lookup/genericwithparameter.aspx?code=STALL&acol_0={0}');", lblStaff.ClientID);
        //btnLookUpStaff.Attributes["href"] = String.Format("javascript:fnShowDialog('../../lookup/genericwithparameter.aspx?code=STALL&acol_0={0}&parc_branch_code={1}');", lblStaff.ClientID, lblBranchCode.ClientID);
        //btnLookUpStaff.Attributes["href"] = String.Format("javascript:fnShowDialog('../../lookup/genericwithparameter.aspx?code=STALL&acol_0={0}&bcol_1={1}&parc_branch_code={2}');", lblStaffCode.ClientID, lblStaffName.ClientID, lblStaffName.ClientID);
        //btnLookUpStaff.Attributes["href"] = String.Format("javascript:fnShowDialog('../../lookup/genericwithparameter.aspx?code=STALL&parc_branch_code={0}');", Shared.CurrentEmployeeBranchCode);
        LoadAfterInit();
    }
    ...
    private void LoadData()
    {
        ...
        try
        {
            ...
            DataRow _dr = _dal.GetRow("", "xsp_request_peralatan_kerja_header_getrow", _ht);
    ...
    protected void btnCancel_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            _ht["p_request_no"] = lblRequestNo.Text;
            //_ht["p_request_date"] = Shared.ToDateTime(txtReqDate.Text);
            ...
            _dal.ExecRawSP("xsp_request_peralatan_kerja_header_cancel", _ht);
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
        ...
        Shared.ShowSuccessGritter(this, string.Format("requestperalatankerja.aspx?action=edit&request_no={0}", lblRequestNo.Text));
    }
    protected void btnBack_Click(object sender, EventArgs e)
    {
        Response.Redirect("requestperalatankerjalist.aspx");
    }
        ...
        try
        {
            ...
            if (fuInvoice.HasFile)
            {
                    ...
                    )
                {
                    ...
                    string sFilePath = Shared.GetUploadPath("FA_REQUEST_PERALATAN_KERJA/DOCUMENT") + lblRequestNo.Text + "/";
            ...
            if (Request.Params["action"].Equals("add"))
            {
                ...
                lblRequestNo.Text = sNextBarcode;
            }
            else
            {
    ...
    private void Post()
    {
        ...
        try
        {
            ...
            //_dal.Update("xsp_request_peralatan_kerja_header_post", _ht);
            _dal.ExecRawSP("xsp_request_peralatan_kerja_header_post", _ht);
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
    ...
    private void Print()
    {
        ...
        htParams["p_request_no"] = lblRequestNo.Text;

        string sFilename = "";

        sFilename = Shared.ExecuteReport(this, "RPT_REQUEST_PERALATAN_KERJA", htParams, CrystalDecisions.Shared.ExportFormatType.PortableDocFormat);
    ...
    {
        Response.Redirect("peralatankerja.aspx?action=add&request_no=" + lblRequestNo.Text + "&ket=" + "request" + "&staff_code=" + txtStaffCode.Text + "&branch_code=" + txtBranchCode.Text);
    }
    ...
    protected void BindData()
    {
        ...
        try
        {
            ...
            gvwList.DataSource = _dal.GetRows("", "xsp_request_peralatan_kerja_detail_getrows", _ht);
            gvwList.DataBind();
        }
        catch (Exception ex)
        {
    ...
    {
        Response.Redirect("peralatankerja.aspx?action=edit&request_no=" + Request.Params["request_no"] + "&id=" + gvwList.SelectedDataKey[0].ToString() + "&ket=" + "request" + "&status=" + lblStatus.Text);
    }
