<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="faadjustlist.aspx.cs" Inherits="module_fa_faadjustlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">
    ...
    <header class="panel-heading">
          <span>Fixed Asset Adjustment List</span>
        </header>
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8">
                    <cc1:XUILinkButton ID="btnAdd" RoleCode="R90000066C" runat="server" CssClass="btn btn-primary" OnClick="btnAdd_Click"><i class="icon-plus"></i>  Create</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnDelete" RoleCode="R90000066D" runat="server" CssClass="btn btn-danger" OnClick="btnDelete_Click"><i class="icon-trash"></i>  Delete</cc1:XUILinkButton>
                </div>
                <div class="col-sm-4">
                        ...
                        <div class="col-sm-5">
                            <cc1:XUIDropDownList ID="ddlStatus" Width="200px" runat="server" CssClass="form-control" SPParameterName="p_status" DataType="String" BindType="Both" AutoPostBack="true" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged">
                             ...
                             <asp:ListItem Text="NEW" Value="NEW"></asp:ListItem>
                              <asp:ListItem Text="ON-PROGRESS" Value="ONPROGRESS"></asp:ListItem>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                             ...
                             <asp:BoundField DataField="Code" HeaderText="Code">
                              ...
                              <asp:BoundField DataField="BRANCH" HeaderText="Cost Center">
                                <ItemStyle Width="15%" />
                            </asp:BoundField>
                           
                              <asp:BoundField DataField="LOC_DESCRIPTION" HeaderText="Location">
                                <ItemStyle Width="15%" />
                            </asp:BoundField>
                            <asp:BoundField DataField="FADJUST_DATE" HeaderText="Date" DataFormatString="{0:dd/MM/yyyy}">
