<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="returnperalatankerjadetail.aspx.cs" Inherits="module_fa_returnperalatankerjadetail" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Return Peralatan Kerja Info</span>
        </header>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <cc1:XUITextBox ID="lblItemName" runat="server" DBColumnName="ITEM_NAME" SPParameterName="p_item_name" DataType="String" BindType="Both"   style="border:0; background:inherit;"></cc1:XUITextBox>
                                </div>
                            </div>                             
                        </div>                
                    </div>
