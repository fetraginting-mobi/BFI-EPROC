<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="returnperalatankerja.aspx.cs" Inherits="module_fa_returnperalatankerja" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Request Pengembalian Peralatan Kerja Info</span>
        </header>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <cc1:XUILabel ID="lblReturnNo" runat="server" DBColumnName="RETURN_NO" DataType="String" BindType="DBToUIOnly" Text="--"></cc1:XUILabel>                        
                                </div>
                            </div>                            
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <cc1:XUITextBox ID="txtReqDate" runat="server" CssClass="form-control default-date-picker" placeholder="Sale Date" DBColumnName="RETURN_DATE" SPParameterName="p_return_date" MaxLength="10" DataType="Datetime" BindType="Both" Format="dd/MM/yyyy"></cc1:XUITextBox>
                    ...
                    <div class="row">
                        <%--<div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                     <cc1:XUITextBox ID="txtRemarks" runat="server" Width="250px" DBColumnName="REMARKS" BindType="Both" DataType="String" SPParameterName="p_remarks" CssClass="form-control"></cc1:XUITextBox>
                                </div>
                            </div>
                         </div>--%>
                         <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                     <cc1:XUIDropDownList ID="ddlResult" runat="server" CssClass="form-control" DBColumnName="RESULT" Width="250px" SPParameterName="p_result" DataType="String" OnSelectedIndexChanged= "ddlResult_SelectedIndexChanged" AutoPostBack= "false" BindType="Both">
                                        <asp:ListItem Value="0" Text="Lost"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="Return"></asp:ListItem>
                                     </cc1:XUIDropDownList>
                                </div>
                            </div>
                         </div>
                         <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <cc1:XUILabel ID="lblStaffName" runat="server"  DBColumnName="EMP_NAME" DataType="String" BindType="DBToUIOnly" Text="-"></cc1:XUILabel>
