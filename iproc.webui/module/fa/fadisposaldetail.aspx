<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="fadisposaldetail.aspx.cs" Inherits="module_fa_fadisposaldetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">    
    <section class="panel">
        ...
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-12">
                    <cc1:XUILinkButton RoleCode="R90000090E" ID="btnSave" runat="server" CssClass="btn btn-primary" OnClick="btnSave_Click"><i class="icon-save"></i>  Save</cc1:XUILinkButton>
        ...
        <div class="panel-body form-horizontal"> 
             <asp:UpdatePanel ID="upd" runat="server">
                <ContentTemplate>
                    ...
                    <!--Barcode-->
                    <cc1:XUILabel ID="lblCodeBarcode" runat="server" DBColumnName="FA_DISPOSAL_CODE" SPParameterName="p_fa_disposal_code" DataType="String" BindType="UIToDBOnly" style="Display:none;" ></cc1:XUILabel>
                    <!--FA_Asset_ID-->
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-4 ">FD No.</label>
                                <div class="col-sm-8">
                                    <cc1:XUILabel ID="lblFaDisposalCode" runat="server" DBColumnName="CODE" DataType="String" BindType="DBToUIOnly" ></cc1:XUILabel>
                                    <cc1:XUILabel ID="lblFDStatus" runat="server" DBColumnName="FD_STATUS" DataType="String" BindType="DBToUIOnly" style="display:none"></cc1:XUILabel>
                                </div>
                            </div>                            
                        </div> 
                    </div> 
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <cc1:XUILabel ID="lblBarcode" runat="server" DBColumnName="BARCODE" SPParameterName="p_barcode" DataType="String" BindType="DBToUIOnly" ></cc1:XUILabel>
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvOrder" runat="server" ErrorMessage="Required Field!" ControlToValidate="txtBarcode" Display="Dynamic"></asp:RequiredFieldValidator> 
                                </div>
                            </div>                            
                        </div> 
                    </div> 
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <cc1:XUILabel ID="lblAssetName" runat="server"  DBColumnName="NAME_ASSET" SPParameterName="p_name_asset" DataType="String" BindType="DBToUIOnly" MaxLength= "60" ></cc1:XUILabel>
                     ...
                     <div class="row">
                        <div class="col-sm-6">
                            ...
                            <label class="col-sm-4">Original Value</label>        
                                <div class="col-sm-5">
                                      <cc1:XUITextBox ID="txtOriginalValue" runat="server"  CssClass="form-control" placeholder="Original Value" DBColumnName="ORIG_PRICE" SPParameterName="p_orig_price" MaxLength="18" DataType="Number" BindType="Both" Format="N2" text="0.00" Enabled="false"></cc1:XUITextBox>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <cc1:XUITextBox ID="txtNetBookValue" runat="server"  CssClass="form-control" placeholder="Net Book Value" DBColumnName="NET_BOOK_VALUE" SPParameterName="p_net_book_value" MaxLength="18" DataType="Number" BindType="Both" Format="N2" text="0.00" Enabled="false" ></cc1:XUITextBox>
                    ...
                    <div class="row">
                         <div class="col-sm-6">
                            ...
                            <label class="col-sm-4">Total Depresiasi</label>        
                                <div class="col-sm-5">
                                    <cc1:XUITextBox ID="txtTotalDepresiasi" runat="server"  CssClass="form-control" placeholder="Total Depresiasi" DBColumnName="TOT_DEPRE" SPParameterName="p_tot_depre" MaxLength="18" DataType="Number" BindType="Both" Format="N2" text="0.00" Enabled="false"></cc1:XUITextBox>
                        ...
                        <div class="col-sm-6">
                            ...
                            <label class="col-sm-4">Purchase Date</label>        
                                <div class="col-sm-5">
                                    <cc1:XUITextBox ID="txtDatePurch" runat="server" CssClass="form-control default-date-picker" placeholder="Purchase Date" DBColumnName="PURCHASE_DATE" SPParameterName="p_purchase_date" MaxLength="10" DataType="Datetime" BindType="Both" Format="dd/MM/yyyy" Enabled="false"></cc1:XUITextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Required Field!" ControlToValidate="txtDatePurch" Display="Dynamic"></asp:RequiredFieldValidator>                
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Format Invalid!" ControlToValidate="txtDatePurch" ValidationExpression="[0-9 .,/()+]*[0-9 .,/()+]" Display="Dynamic" ></asp:RegularExpressionValidator>
                                </div>
                            </div>
                        </div> 
                    </div>
     ...
     <asp:Panel runat="server" ID="pnlDoc">
        <section class="panel">
            <header class="panel-heading">
              <span>Disposal Document</span>
            </header>
             
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-sm-8 ">
                            <cc1:XUILinkButton RoleCode="R50000050E" ID="btnAdd" runat="server" CssClass="btn btn-primary" OnClick="btnAdd_Click"><i class="icon-plus"></i>  Create</cc1:XUILinkButton>
