<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="historyperalatan.aspx.cs" Inherits="module_fa_historyperalatan" %>
                    ...
                    AllowPaging="true" PageSize="10" DataKeyNames=""
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="EMP_NAME" HeaderText="Employee Name">
                             ...
                             <asp:BoundField DataField="IS_RETURN" HeaderText="Is Return ?">
                                <ItemStyle Width="10%" />
                            </asp:BoundField>
                              <asp:BoundField DataField="RETURN_NO" HeaderText="Return No">
                                <ItemStyle Width="10%" HorizontalAlign="Center"/>
                            </asp:BoundField>
