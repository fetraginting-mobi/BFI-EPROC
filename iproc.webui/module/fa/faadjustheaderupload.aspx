<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="faadjustheaderupload.aspx.cs" Inherits="module_fa_faadjustheaderupload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
 <section class="panel">
        ...
        <div class="panel-body form-horizontal">
            ...
            <cc1:XUILabel ID="lblCode" runat="server"  DBColumnName="CODE" SPParameterName="p_code" DataType="String" BindType="UIToDBOnly" MaxLength="14"  style = "Display:none;"></cc1:XUILabel>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <cc1:XUILabel ID="lblInvoiceCode" runat="server" DBColumnName="" DataType="String" BindType="DBToUIOnly"></cc1:XUILabel>
                           </div>
                        </div>
                    </div>                            
                </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <cc1:XUITextBox ID="txtDocumentName" runat="server" CssClass="form-control" placeholder="Description" DBColumnName="DESCRIPTION" MaxLength="50" SPParameterName="@p_description" DataType="String" BindType="Both"></cc1:XUITextBox>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                        <cc1:XUILabel ID="lblFILE" runat="server" DBColumnName="" DataType="String" BindType="DBToUIOnly"></cc1:XUILabel>
