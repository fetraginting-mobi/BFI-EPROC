<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="fasaledocument.aspx.cs" Inherits="module_fa_fasaledocument" %>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <cc1:XUILabel ID="lblFaSaleCode" runat="server" DBColumnName="FA_CODE" DataType="String" BindType="DBToUIOnly"></cc1:XUILabel>
                                   </div>
                                </div>
                            </div>                            
                        </div>
