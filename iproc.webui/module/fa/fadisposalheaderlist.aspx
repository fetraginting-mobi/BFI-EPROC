<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="fadisposalheaderlist.aspx.cs" Inherits="module_fa_fadisposalheaderlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">
    ...
    <header class="panel-heading">
          <span>Fixed Asset Disposal List</span>
        </header>
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8">
                    <cc1:XUILinkButton ID="btnAdd" RoleCode="R90000090C" runat="server" CssClass="btn btn-primary" OnClick="btnAdd_Click"><i class="icon-plus"></i>  Create</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnDelete" RoleCode="R90000090D" runat="server" CssClass="btn btn-danger" OnClick="btnDelete_Click"><i class="icon-trash"></i>  Delete</cc1:XUILinkButton>
                </div>
                <div class="col-sm-4">
                    ...
                    AllowPaging="true" PageSize="10" DataKeyNames="CODE_BARCODE"
                        ...
                        <Columns>
                           ...
                           <asp:TemplateField>
                            ...
                            <asp:BoundField DataField="DISPOSAL_DATE" HeaderText="Date" DataFormatString="{0:dd/MM/yyyy}">
                                <ItemStyle Width="20%" HorizontalAlign="Center"/>
                            </asp:BoundField>
                            <asp:BoundField DataField="FROM_DESCRIPTION" HeaderText="From Cost Center">
                                <ItemStyle Width="20%" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="REASON" HeaderText="Disposal Reason">
                                <ItemStyle Width="10%" />
                            </asp:BoundField>
