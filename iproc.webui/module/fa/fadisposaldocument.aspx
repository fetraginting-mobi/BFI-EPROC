<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="fadisposaldocument.aspx.cs" Inherits="module_fa_fadisposaldocument" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
 <section class="panel">
        ...
        <div class="panel-body form-horizontal">
                    ...
                    <cc1:XUILabel ID="lblFaCode" runat="server"  DBColumnName="FA_CODE" SPParameterName="p_fa_code" DataType="String" BindType="UIToDBOnly" MaxLength="14"  style = "Display:none;"></cc1:XUILabel>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-3">FA Disposal Code.</label>
                                <div class="col-sm-5">
                                    <cc1:XUILabel ID="lblFaDisposalCode" runat="server" DBColumnName="FA_DISPOSAL_CODE" DataType="String" BindType="DBToUIOnly"></cc1:XUILabel>
                                   </div>
                                </div>
                            </div>                            
                        </div>
