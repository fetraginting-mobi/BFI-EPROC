...
public partial class module_supplier_supplierinfo : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            Shared.BindCreditorType(ddlCreditorTypeCode);
            ...
            if (Request.Params["action"].Equals("edit"))
            {
                ...
                {
                    btnPost.Visible = btnInValid.Visible = btnSave.Visible = btnAddBank.Visible = btnDeleteBank.Visible = btnAddGroup.Visible = btnDeleteGroup.Visible = true;
                ...
                {
                    btnPost.Visible = btnInValid.Visible = btnSave.Visible = btnAddBank.Visible = btnDeleteBank.Visible = btnAddGroup.Visible = btnDeleteGroup.Visible = false;
