<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="supplierinfolist.aspx.cs"
    Inherits="module_supplier_supplierinfolist" Title="Untitled Page" %>
                ...
                <ContentTemplate>
                    ...
                    AllowPaging="true" PageSize="10" DataKeyNames="SUPPLIER_CODE"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="STATUS_TYPE" HeaderText="Creditor Type">
