<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="supplierinfo.aspx.cs" Inherits="module_supplier_supplierinfo" Title="Untitled Page" %>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <label class="col-sm-3">Supplier Type</label>
                    <div class="col-sm-7">
                        <cc1:XUIRadioButtonList ID="rblSupplierType" runat="server"  DBColumnName="SUPPLIER_TYPE" SPParameterName="p_supplier_type" DataType="String" BindType="Both" RepeatLayout="Table" RepeatDirection="Horizontal" >
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <cc1:XUITextBox ID="txtPhone" runat="server" CssClass="form-control" placeholder="Phone" DBColumnName="PHONE" SPParameterName="p_phone" MaxLength="15" DataType="String" BindType="Both"></cc1:XUITextBox>
