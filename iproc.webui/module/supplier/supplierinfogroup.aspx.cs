...
public partial class module_supplier_supplierinfogroup : BasePage
{
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            if (Request.Params["action"].Equals("add"))
            {
                ...
                Shared.ShowSuccessGritter(this, string.Format("supplierinfogroup.aspx?action=edit&suppliercode={0}&id={1}&id_dt={2}", Request.Params["suppliercode"], Request.Params["id"], lblId.Text));
            }
