<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="purchasequotationdocumentdetail.aspx.cs" Inherits="module_purchaseorder_purchasequotationdocumentdetail" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">   
    <section class="panel">
        ...
        <div class="panel-body form-horizontal">
                    ...
                    <cc1:XUILabel ID="lblBarcode" runat="server"  DBColumnName="PQ_CODE" SPParameterName="p_pq_code" DataType="String" BindType="UIToDBOnly" MaxLength="14"  style = "Display:none;"></cc1:XUILabel>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Required Field!" ControlToValidate="fupFilename" Display="Dynamic"></asp:RequiredFieldValidator> 
                                </div>                            
                            </div>
                        </div>
                    </div>
