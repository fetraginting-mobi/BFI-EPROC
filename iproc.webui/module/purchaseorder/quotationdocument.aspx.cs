...
public partial class module_purchaseorder_quotationdocument : BasePage
{
    ...
    private void BindDataDocRequest()
    {
        ...
        try
        {
            ...
            _ht["p_pq_code"] = Request.Params["pq_code"];
          
            gvwListDocReq.DataSource = _dal.GetRows("", "xsp_quotation_documentss_getrows", _ht).DefaultView;
