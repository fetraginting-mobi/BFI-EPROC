...
public partial class module_purchaseorder_viewdocumetquotationreview : BasePage
{
    ...
    private void BindDataDocRequest()
    {
        ...
        try
        {
            ...
            gvwListDocReq.DataSource = _dal.GetRows("", "xsp_view_quotation_review_document_getrows", _ht).DefaultView;
