<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="grndocument.aspx.cs" Inherits="module_purchaseorder_grndocument" %>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-3">GRN Code.</label>
                                <div class="col-sm-5">
                                    <cc1:XUILabel ID="lblCode" runat="server" DBColumnName="GRN_CODE" DataType="String" BindType="DBToUIOnly"></cc1:XUILabel>
