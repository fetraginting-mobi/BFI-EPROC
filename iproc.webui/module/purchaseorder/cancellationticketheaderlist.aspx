<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="cancellationticketheaderlist.aspx.cs" Inherits="module_purchaseorder_cancellationticketheaderlist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">    
    <section class="panel">
        <header class="panel-heading">
            <span>Cancellation Ticket List</span>
        </header>
                    ...
                    <label class="col-sm-3">Status</label>
                        <div class="col-sm-5">
                            <cc1:XUIDropDownList ID="ddlStatus" Width="200px" runat="server" CssClass="form-control" SPParameterName="p_status" DataType="String" BindType="Both" AutoPostBack="true" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged">
                                ...
                                <asp:ListItem Value="ON-PROCRESS" Text="ON-PROCRESS"></asp:ListItem>
