<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="supplierhistory.aspx.cs" Inherits="module_purchaseorder_supplierhistory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    ...
    <section class="panel">
        <header class="panel-heading">
          <span> Supplier History List </span>
        ...
        <div class="panel-heading">
            <div class="row">
               <div class="col-sm-8 ">
                ...
                <%--<cc1:XUILinkButton ID="btnCancel" RoleCode="" runat="server" CssClass="btn btn-danger" onclick="parent.fnHideGenericScreen();" CausesValidation="false"><i class="icon-arrow-left"></i>  Cancel</cc1:XUILinkButton>--%>
                ...
                <ContentTemplate>
                    ...
                    AllowPaging="true" PageSize="10" DataKeyNames=""
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="SUPPLIER_CODE" HeaderText="Supplier Name">
                                <ItemStyle Width="20%" HorizontalAlign="Center"/>
                            </asp:BoundField>
                             <asp:BoundField DataField="BRANCH_CODE" HeaderText="Trx Branch">
                                <ItemStyle Width="20%" HorizontalAlign="Center"/>
                            </asp:BoundField>
