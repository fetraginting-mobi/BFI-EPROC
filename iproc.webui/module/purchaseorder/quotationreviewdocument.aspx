<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="quotationreviewdocument.aspx.cs" Inherits="module_purchaseorder_quotationreviewdocument" %>
    ...
    <section class="panel">
        ...
        <div class="panel-body form-horizontal">
                   ...
                   <%-- <cc1:XUILabel ID="lblIdDetail" runat="server" Visible="false" BindType="Both" DBColumnName="ID_DETAIL" SPParameterName="p_id_detail" DataType="Integer" Text=0></cc1:XUILabel>--%>
                    <cc1:XUILabel ID="lblBarcode" runat="server"  DBColumnName="PQW_CODE" SPParameterName="p_pqw_code" DataType="String" BindType="UIToDBOnly" MaxLength="14"  style = "Display:none;"></cc1:XUILabel>
