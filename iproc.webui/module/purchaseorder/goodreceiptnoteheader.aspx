<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="goodreceiptnoteheader.aspx.cs" Inherits="module_purchaseorder_goodreceiptnoteheader" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">   
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <cc1:XUILinkButton ID="btnReject" RoleCode="R50000080O" runat="server" 
                        CssClass="btn btn-danger"  CausesValidation="false" onclick="btnReject_Click"><i class="icon-remove"></i>  Cancel</cc1:XUILinkButton>
        ...
        <div class="panel-body form-horizontal">
            <asp:UpdatePanel ID="UpdatePanel1" UpdateMode="Conditional" runat="server">
                <ContentTemplate>
                    ...
                    <cc1:XUILabel ID="lblOrderType" runat="server" DBColumnName="ORDER_TYPE" DataType="String" BindType="DBToUIOnly" style="display:none"></cc1:XUILabel>
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                               ...
                               <%--ID APPROVEL--%>
                                ...
                                <div class="col-sm-8">
                                    <cc1:XUILabel ID="lblCode" runat="server" DBColumnName="CODE" SPParameterName="p_grn_code" DataType="String" BindType="Both" Text="--"></cc1:XUILabel>
                                </div>
                            </div>                            
                        </div>
                        <div class="col-sm-6">
                         ...
                         <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <cc1:XUITextBox ID="txtPurchaseOrderCode" style="display:none" runat="server" CssClass="form-control" DBColumnName="PURCHASE_ORDER_CODE" SPParameterName="p_purchase_order_code" MaxLength="14" DataType="String" BindType="Both"></cc1:XUITextBox>
                                 ...
                                 <div class="col-sm-2">
                                      <cc1:XUILinkButton ID="btnViewHistory" runat="server" CausesValidation="false" Text="View PO"></cc1:XUILinkButton>
                               </div>
                            </div>                            
                         </div>
                         <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8"> 
                                    <cc1:XUITextBox ID="txtSupplierID" style="display:none" runat="server" CssClass="form-control" DBColumnName="SUPPLIER_CODE" SPParameterName="p_supplier_code" DataType="String" BindType="Both"></cc1:XUITextBox>
                         ...
                         <div class="col-sm-6" runat="server">
                             <div class="form-group">
                                 <label class="col-sm-4">Supplier Rating *</label>
                                    <div class="col-sm-6">
                                     <cc1:XUIDropDownList ID="ddlRating" runat="server" CssClass="form-control" DBColumnName="RATING" SPParameterName="p_rating" BindType="Both"  DataType="String">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <cc1:XUITextBox ID="txtRemarks" runat="server" CssClass="form-control" placeholder="Description" DBColumnName="REMARKS" SPParameterName="p_remarks" MaxLength="400" DataType="String" BindType="Both" TextMode="MultiLine"></cc1:XUITextBox>
                                     <asp:RequiredFieldValidator ID="rvfRemarks" runat="server" ErrorMessage="Required Field!" ControlToValidate="txtRemarks" Display="Dynamic"></asp:RequiredFieldValidator> 
                                </div>
                            </div>                            
                        </div>
                    </div>
    ...
    <asp:Panel runat="server" ID="pnlItemList">
        <section class="panel">
            ...
            <div class="row">
                <div class="col-sm-8">
                    <%--<asp:LinkButton ID="btnAddRequestDetail" runat="server" CssClass="btn btn-primary" OnClick="btnAddRequestDetail_Click" CausesValidation="false"><i class="icon-plus"></i>  Create</asp:LinkButton>--%>
                    <cc1:XUILinkButton RoleCode="R50000080E" ID="btnDeleteRequestDetail" runat="server" CssClass="btn btn-danger" OnClick="btnDeleteRequestDetail_Click" CausesValidation="false"><i class="icon-trash"></i>  Delete</cc1:XUILinkButton>
                </div>
                <div class="col-sm-4">
                ...
                <ContentTemplate>
                    <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="false" CssClass="display table table-bordered table-striped"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="PO_QUANTITY" HeaderText="PO Quantity" DataFormatString="{0:N2}">
                                <ItemStyle Width="10%" HorizontalAlign="Right"  />
                            </asp:BoundField>
                            <asp:BoundField DataField="RECEIVE_QUANTITY" HeaderText="Receive" DataFormatString="{0:N2}">
                                <ItemStyle Width="10%" HorizontalAlign="Right"/>
                            </asp:BoundField>
