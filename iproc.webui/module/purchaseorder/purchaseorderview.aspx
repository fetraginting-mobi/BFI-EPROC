<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="purchaseorderview.aspx.cs" Inherits="purchaseorderview" %>
        ...
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <cc1:XUILinkButton ID="btnSave" RoleCode="R50000070E" runat="server" CssClass="btn btn-primary" OnClick="btnSave_Click" style="display:none;"><i class="icon-save" style="display:none;"></i>  Save</cc1:XUILinkButton>
                    <cc1:XUILinkButton RoleCode="R50000070O" ID="btnApprovalTiered" Visible ="false" runat="server" CssClass="btn btn-success" ><i class="icon-ok" style="display:none;"></i>  Approval</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnPost" RoleCode="R50000070O" runat="server" CssClass="btn btn-success" style="display:none;"><i class="icon-envelope" style="display:none;"></i>   Post</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnReject" RoleCode="R50000070O" runat="server" CssClass="btn btn-danger" CausesValidation="false" style="display:none;"><i class="icon-remove" style="display:none;"></i>  Cancel</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnClose" RoleCode="" runat="server" CssClass="btn btn-danger" CausesValidation="false" OnClick="btnClose_Click" style="display:none;"><i class="icon-remove" style="display:none;"></i>  Closed</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnPrint" RoleCode="R50000070P" runat="server" CssClass="btn btn-primary" OnClick="btnPrint_Click" CausesValidation="false" style="display:none;"><i class="icon-print" style="display:none;"></i>  Print</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnCancel" RoleCode="" runat="server" CssClass="btn btn-danger" OnClick="btnCancel_Click" CausesValidation="false" style="display:none;"><i class="icon-remove" style="display:none;"></i>  Cancel</cc1:XUILinkButton>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <asp:RequiredFieldValidator ID="revDueDate" runat="server" ErrorMessage="Required Field!" ControlToValidate="txtDueDate" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Required Field!" ControlToValidate="txtDueDate" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                               <label class="col-sm-4">Payment By *</label>
                                  <div class="col-sm-4">
                                     <cc1:XUIDropDownList ID="ddlPaymentBy" runat="server" CssClass="form-control" DBColumnName="PAYMENT_BY" SPParameterName="p_payment_by" BindType="Both" DataType="String" Enabled="false" >
                       ...
                       <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <cc1:XUIDropDownList ID="ddlReceiptBy" runat="server" CssClass="form-control" DBColumnName="RECEIPT_BY" SPParameterName="p_receipt_by" BindType="Both" DataType="String" Enabled="false" >
                                       <asp:ListItem Selected Value="0" Text="-=Select=-"></asp:ListItem>
