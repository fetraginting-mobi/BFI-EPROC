<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="purchaseorderdetail.aspx.cs" Inherits="module_purchaseorder_purchaseorderdetail" Title="Untitled Page" %><%@ Register Assembly="MPF23.XUI" Namespace="MPF23.XUI.Control" TagPrefix="cc1" %> <asp:Content ID="Content1" ContentPlaceHolderID="cph" Runat="Server">
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
   <section class="panel">
      ...
      <div class="panel-heading">
         <div class="row">
            <div class="col-sm-12">
               <cc1:XUILinkButton RoleCode="R50000070E" ID="btnSave" runat="server" CssClass="btn btn-primary" OnClick="btnSave_Click">
                  <i class="icon-save"></i> Save
               </cc1:XUILinkButton>
               <cc1:XUILinkButton ID="btnCancel" RoleCode="" runat="server" CssClass="btn btn-danger" OnClick="btnCancel_Click" CausesValidation="false">
                  <i class="icon-remove"></i> cancel
               </cc1:XUILinkButton>
               <cc1:XUILinkButton ID="btnCancelAp" style="Display:none;" Visible="false" RoleCode="" runat="server" CssClass="btn btn-danger" OnClick="btnCancelApp_Click" CausesValidation="false">
                  <i class="icon-remove"></i> cancel
               </cc1:XUILinkButton>
            </div>
         </div>
      </div>
      <div class="panel-body form-horizontal"><%--ID--%> <cc1:XUILabel ID="lblID" runat="server" DBColumnName="ID" SPParameterName="p_id" DataType="String" BindType="Both" Text="0" style="Display:none;"></cc1:XUILabel><%--Barcode--%> <cc1:XUILabel ID="lblBarcode" runat="server" DBColumnName="PO_BARCODE" SPParameterName="p_po_code" DataType="String" BindType="UIToDBOnly" MaxLength="14" style="Display:none;"></cc1:XUILabel><%--Currency--%> <cc1:XUILabel ID="lblCurrencyUI" runat="server" DBColumnName="CURRENCY_CODE" SPParameterName="p_currency_code" DataType="String" BindType="Both" style="Display:none;"></cc1:XUILabel><%--Status Flag--%> <cc1:XUILabel ID="lblStatus" runat="server" DBColumnName="STATUS" DataType="String" BindType="DBToUIOnly" style="Display:none;"></cc1:XUILabel>
         ...
         <div class="row">
            <div class="col-sm-6">
               <div class="form-group">
                  ...
                  <div class="col-sm-8">
                     <asp:LinkButton runat="server" ID="btnLookUpPurchaseQuotation" class="btn btn-primary" Enabled="false" data-toggle="modal" CausesValidation="false">
                  ...
                  <div class="col-sm-6">
                     <asp:UpdatePanel ID="updDiv" runat="server">
                        <ContentTemplate>
                           ...
                           <asp:RequiredFieldValidator ID="revddlDivision" runat="server" ControlToValidate="ddlDivision" ErrorMessage="Value Required!" InitialValue="-"></asp:RequiredFieldValidator>
                        </ContentTemplate>
                     </asp:UpdatePanel>
                  </div>
               </div>
         ...
         <div class="row">
            <div class="col-sm-6">
               <div class="form-group">
                  ...
                  <div class="col-sm-8">
                     <asp:LinkButton runat="server" ID="btnLookUpItem" class="btn btn-primary" data-toggle="modal" CausesValidation="false">
                        <i class="icon-table"></i>
                     </asp:LinkButton>
         ...
         <div class="row">
            <div class="col-sm-6">
               <div class="form-group">
                  ...
                  <div class="col-sm-8">
                     <asp:LinkButton runat="server" ID="btnLookUpRequestoro" class="btn btn-primary" data-toggle="modal" CausesValidation="false">
                        <i class="icon-table"></i>
                     </asp:LinkButton>
                  ...
                  <div class="col-sm-4">
                     <div class="input-group">
                        ...
                        <cc1:XUILabel ID="lblMonth" runat="server">&nbsp&nbsp Days</cc1:XUILabel><%-- 
								<asp:RequiredFieldValidator ID="rfvDeliveryDuration" runat="server" ErrorMessage="Required Field!" ControlToValidate="txtDeliveryDuration" Display="Dynamic"></asp:RequiredFieldValidator>--%> <asp:RegularExpressionValidator ID="refDeliveryDuration" runat="server" ErrorMessage="Format Invalid!" ControlToValidate="txtDeliveryDuration" ValidationExpression="[0-9 .,/()]*[0-9 .,/()]" Display="Dynamic"></asp:RegularExpressionValidator>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="row">
            ...
            </div><%--(+) Ari 30-12-2022 ket : enhancement 2022, jika group role multiplebranch dapat akses pilih branch--%> 
            <div class="col-sm-6">
               <div class="form-group">
                  <label class="col-sm-4">Is Multiplebranch</label>
                  <div class="col-sm-4">
         ...
         <div class="row">
            ...
            <div class="col-sm-6"  ID="LTB" runat="server"  visible="false" > 
               <div class="form-group">
                  <label class="col-sm-4">Lease Tax Borne By *</label>
                  <div class="col-sm-4">
                    <cc1:XUIDropDownList ID="ddlLeaseTax" Width="100px" runat="server" CssClass="form-control" DBColumnName="LEASE_TAX" SPParameterName="p_lease_tax" DataType="String" BindType="Both" AutoPostBack="true">
                        <asp:ListItem Text="-" Value="-"></asp:ListItem>
                        <asp:ListItem Text="BFI" Value="BFI"></asp:ListItem>
                        <asp:ListItem Text="Owner" Value="Owner"></asp:ListItem>
                    </cc1:XUIDropDownList>
                    <asp:RequiredFieldValidator 
                        ID="rfvLeaseTax" 
                        runat="server" 
                        ControlToValidate="ddlLeaseTax"
                        InitialValue="-" 
                        ErrorMessage="Please Select Lease Tax!" 
                        Display="Dynamic" 
                        ForeColor="Red">
                    </asp:RequiredFieldValidator>
                      <%--<cc1:XUICheckBox ID="chbLeaseTax" runat="server" DBColumnName="LEASE_TAX" SPParameterName="p_lease_tax" DataType="String" BindType="Both"/>--%>
                  </div>
               </div>
            </div>
         </div>
