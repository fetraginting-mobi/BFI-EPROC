...
public partial class module_purchaseorder_goodreceiptnoteheaderlist : BasePageList
{
    private static string TABLE_NAME = "GOOD_RECEIPT_NOTE_HEADER";

    protected void Page_Init(object sender, EventArgs e)
    {
        PAGE_LIST = "GOOD_RECEIPT_NOTE_HEADER";
        NEXT_PAGE = "goodreceiptnoteheader.aspx";
    }
    ...
    {
        Response.Redirect("goodreceiptnoteheader.aspx?action=add");
    }
    ...
    protected override void SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("goodreceiptnoteheader.aspx?action=edit&codebarcode=" + gvwList.SelectedDataKey[0].ToString());
    }
