...
public partial class module_purchaseorder_supplierhistory : BasePage
{
    private static string TABLE_NAME = "SUPPLIER_HISTORY";
    ...
    private void BindData()
    {
        ...
        try
        {
            ...
            gvwList.DataSource = _dal.GetRows("", "dbo.xsp_supplier_history_getrows", _ht);
            gvwList.DataBind();
        }
        catch (Exception ex)
        {
