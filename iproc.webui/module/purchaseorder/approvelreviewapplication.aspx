<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="approvelreviewapplication.aspx.cs" Inherits="module_purchaseorder_approvelreviewapplication" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    ...
    <section class="panel">
        <header class="panel-heading">
          <span> Approval Review List </span>
        </header>
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8">
                <cc1:XUILabel ID="lblCodeBarcode" runat="server" DBColumnName="CODE_BARCODE" DataType="String" BindType="DBToUIOnly" style="display:none"></cc1:XUILabel>
