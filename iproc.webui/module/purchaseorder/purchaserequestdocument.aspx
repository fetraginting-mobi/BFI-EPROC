<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="purchaserequestdocument.aspx.cs" Inherits="module_purchaseorder_purchaserequestdocument" %>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-3">PR Code.</label>
                                <div class="col-sm-5">
