...
public partial class module_purchaseorder_documentrequest : BasePage
{
    ...
    private void BindDataDocRequest()
    {
        ...
        try
        {
            ...
            gvwListDocReq.DataSource = _dal.GetRows("","xsp_purchase_request_document_getrows" ,_ht).DefaultView;
