...
public partial class module_purchaseorder_quotationreviewdocument : BasePage
{
    private static string TABLE_NAME = "PURCHASE_QUOTATION_REVIEW_DOCUMENT";
    ...
    private void GetCode()
    {
        ...
        try
        {
            ...
            DataRow _dr = _dal.GetRow("PURCHASE_QUOTATION_REVIEW_HEADER", _ht);
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            _ht["p_pqw_code"] = Request.Params["codebarcode"];
            ...
            Shared.ShowSuccessGritter(this, string.Format("purchasequotationreviewheader.aspx?action=edit&codebarcode={0}",Request.Params["codebarcode"]));
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
