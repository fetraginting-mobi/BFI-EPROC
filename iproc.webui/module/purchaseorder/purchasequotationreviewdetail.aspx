<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="purchasequotationreviewdetail.aspx.cs" Inherits="module_purchaseorder_purchasequotationreviewdetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">    
    <section class="panel">
        ...
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-12">
                    <cc1:XUILinkButton RoleCode="R50000045E" ID="btnSave" runat="server" CssClass="btn btn-primary" style = "Display:none;" OnClick="btnSave_Click"><i class="icon-save"></i></cc1:XUILinkButton>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <cc1:XUILabel ID="lblPurchaseQuotationCode" runat="server" DBColumnName="PQR_CODE" DataType="String" BindType="DBToUIOnly" MaxLength="14" ></cc1:XUILabel>
                   ...
                   <div class="row"> 
                        <div class="col-sm-6" style = "Display:none;">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:LinkButton runat="server" ID="btnLookUpSupplierID" class="btn btn-primary" data-toggle="modal" CausesValidation="false" style = "Display:none;"><i class="icon-table"></i></asp:LinkButton>                                    
                                    ...
                                    <cc1:XUILabel ID="lblSupplierName" runat="server"  DBColumnName="SUPPLIER_NAME" DataType="String" BindType="DBToUIOnly" Text="--" style = "Display:none;"></cc1:XUILabel>
                                </div>
                            </div>                            
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row"> 
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <cc1:XUITextBox ID="txtOrderQuantity" runat="server" CssClass="form-control" placeholder="Order Quantity" DBColumnName="QUANTITY" SPParameterName="p_quantity" DataType="Number" BindType="Both" MaxLength="8" Format="N2"></cc1:XUITextBox>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <cc1:XUILabel ID="txtTotal" runat="server" CssClass="form-control" DBColumnName="TOTAL" DataType="Number" Format="N2" BindType="DBToUIOnly"></cc1:XUILabel>
                            </div>                            
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <cc1:XUITextBox ID="txtRemarks" runat="server" CssClass="form-control" placeholder="Remarks" DBColumnName="REMARKS" SPParameterName="p_remarks" DataType="String" BindType="Both" MaxLength="4000" TextMode="MultiLine"></cc1:XUITextBox>
                                    <asp:RegularExpressionValidator runat="server" ID="valInput" ControlToValidate="txtRemarks" ValidationExpression="^[\s\S]{0,400}$" ErrorMessage="Exceed maximum length 4000" Display="Dynamic"></asp:RegularExpressionValidator>
                                </div>
                            </div>                            
                        </div>
                    </div>
