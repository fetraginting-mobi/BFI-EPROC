<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="masterorderdocument.aspx.cs" Inherits="module_commonmst_masterorderdocument" Title="Untitled Page" %>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-3">PO Code.</label>
                                <div class="col-sm-5">
