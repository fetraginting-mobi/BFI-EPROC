                    ...
                    <div class="panel-body">
                         <div class="row">    
                           ...
                           <div class="col-sm-3">
                                ...
                                <label class="col-sm-3">Owner</label>
                                    <div class="col-sm-8">
                                      <cc1:XUIDropDownList ID="ddlOwnerPO" Width="200px" runat="server" CssClass="form-control" DBColumnName="OWNER_CODE" SPParameterName="p_owner_po" DataType="String" BindType="Both" AutoPostBack="true" OnSelectedIndexChanged="ddlOwnerPO_SelectedIndexChanged" ></cc1:XUIDropDownList>
                                    </div>
                                </div>
                            </div>
                         </div> 
