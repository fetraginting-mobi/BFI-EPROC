...
public partial class module_purchaseorder_grndocument : BasePage
{
    private static string TABLE_NAME = "GRN_DOCUMENT";
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            _ht["p_grn_code"] = Request.Params["codebarcode"];
            ...
            Shared.ShowSuccessGritter(this, string.Format("goodreceiptnoteheader.aspx?action=edit&codebarcode={0}", Request.Params["codebarcode"]));
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
    ...
    {
        Response.Redirect("goodreceiptnoteheader.aspx?action=edit&codebarcode=" + Request.Params["codebarcode"]);
    }
