<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="supplierselectionheaderlist.aspx.cs" Inherits="module_purchaseorder_supplierselectionheaderlist" %>
             ...
             <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <cc1:XUITextBox ID="txtFromDate" runat="server" Width="100px" CssClass="form-control default-date-picker-all" DBColumnName="SELECTION_DATE" SPParameterName="p_from_date" DataType="DateTime" BindType="Both" Format="dd/MM/yyyy"></cc1:XUITextBox> 
                        </div>
                    </div>                            
                </div>
                 <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <cc1:XUITextBox ID="txtToDate" runat="server" Width="100px" CssClass="form-control default-date-picker-all" DBColumnName="SELECTION_DATE" SPParameterName="p_to_date" DataType="DateTime" BindType="Both" Format="dd/MM/yyyy" OnTextChanged="txtToDateChanged" AutoPostBack="true"></cc1:XUITextBox>
                        </div>
                    </div>                            
                </div>
                 <div class="row">
                    ...
                    <asp:GridView ID="gvwList" runat="server" AutoGenerateColumns="false" CssClass="display table table-bordered table-striped"
                        ...
                        <Columns>
                           ...
                           <%-- <asp:TemplateField>
                            ...
                            <asp:BoundField DataField="CODE" HeaderText="SS No.">
                                <ItemStyle Width="15%" HorizontalAlign="Center" />
                            </asp:BoundField>       
                            <asp:BoundField DataField="PQ_CODE" HeaderText="PQ No.">
                                <ItemStyle Width="15%" HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="EXP_DATE" HeaderText="Exp Date" DataFormatString="{0:dd/MM/yyyy}">
                                <ItemStyle Width="10%" HorizontalAlign="Center"/>
                            </asp:BoundField>
