...
public partial class module_purchaseorder_quotationreview : BasePageList
{
    private static string TABLE_NAME = "PURCHASE_QUOTATION_REVIEW_HEADER";

    protected void Page_Init(object sender, EventArgs e)
    {
        PAGE_LIST = "PURCHASE_QUOTATION_HEADER";
        NEXT_PAGE = "purchasequotationheader.aspx";
    }
    ...
    {
        Response.Redirect("purchasequotationheader.aspx?action=add");
    }
    ...
    protected override void SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("purchasequotationreviewheader.aspx?action=edit&codebarcode=" + gvwList.SelectedDataKey[0].ToString());
    }
