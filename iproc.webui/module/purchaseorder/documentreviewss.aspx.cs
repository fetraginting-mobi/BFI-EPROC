...
public partial class module_purchaseorder_documentreviewss : BasePage
{
    ...
    private void BindDataDocRequest()
    {
        ...
        try
        {
            ...
            gvwListDocReq.DataSource = _dal.GetRows("", "xsp_purchase_request_documentss_getrows", _ht).DefaultView;
