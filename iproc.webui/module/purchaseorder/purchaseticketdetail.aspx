<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="purchaseticketdetail.aspx.cs" Inherits="module_purchaseorder_purchaseticketdetail" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph" Runat="Server">
   <script  type="text/javascript">
        ...
        {
            __doPostBack('ctl00$cpb$ddlReffType', '');
        }
    </script>
</asp:Content>
            ...
            <div class="row">
                <div class="col-sm-6">
                 ...
                 <div class="col-sm-6">
                  ...
                  <div class="col-sm-2">
                                      <cc1:XUILinkButton ID="btnViewHistory" runat="server" CausesValidation="false" Text="Data Ticket"></cc1:XUILinkButton>
                        </div>   
              </div>
              <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="col-sm-2">Code Booking</label> 
                        <span class="col-sm-2" id="mandatory" runat="server">*</span> 
                        <span class="col-sm-0" id="spasi" runat="server"></span>    
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <cc1:XUIDropDownList ID="ddlReffType" runat="server" CssClass="form-control" DBColumnName="REFF_TYPE"  AutoPostBack="true"  OnSelectedIndexChanged="ddlReffType_SelectedIndex" SPParameterName="p_reff_type" DataType="String" BindType="Both">
                              ...
                              <asp:ListItem Value="TK">Tiket Kereta</asp:ListItem>
                            </cc1:XUIDropDownList>
                 ...
                 <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <cc1:XUITextBox ID="txtRequestorCode"  runat="server"  CssClass="form-control" DBColumnName="NAMA" SPParameterName="p_nama" DataType="String" BindType="Both"></cc1:XUITextBox>
                            <cc1:XUITextBox ID="txtRequestorName"  runat="server"  CssClass="form-control" DBColumnName="REQUESTOR_NAME" style="Display:none;" DataType="String" BindType="DBToUIOnly"></cc1:XUITextBox>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                         <cc1:XUITextBox ID="txtRequestorNIK"  runat="server"  CssClass="form-control" DBColumnName="NIK" SPParameterName="p_nik" DataType="String" BindType="Both"></cc1:XUITextBox>
                         <asp:RequiredFieldValidator ID="rvfRequestorNIK" runat="server" ErrorMessage="Required Field!" ControlToValidate="txtJabatan" Display="Dynamic"></asp:RequiredFieldValidator>   
                        </div>
                    </div>                            
                </div>                        
                <div class="col-sm-6">
          ...
          <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <asp:RegularExpressionValidator ID="revLowestPrice" runat="server" ErrorMessage="Format Invalid!" ControlToValidate="txtLowestPrice" ValidationExpression="[0-9 .,/()]*[0-9 .,/()]" Display="Dynamic"></asp:RegularExpressionValidator>
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Required Field!" ControlToValidate="txtLowestPrice" InitialValue="0.00" Display="Dynamic"></asp:RequiredFieldValidator>       
                        </div>
                    </div>                            
                </div> 
            </div>  
                ...
                <div class="col-sm-6" ID="FRM" runat="server">
                     ...
                     <div class="col-sm-6" ID="DTM" runat="server">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <cc1:XUITextBox ID="txtdeparturetime" runat="server" CssClass="form-control default-date-picker-ticket" placeholder="Departure Date" DBColumnName="WAKTU_KEBERANGKATAN" SPParameterName="p_waktu_keberangkatan" DataType="Datetime" BindType="Both" Format="dd/MM/yyyy"></cc1:XUITextBox>
            ...
            <div class="row">
                    ...
                    <div class="col-sm-6" ID="WKB" runat="server">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <cc1:XUITextBox ID="txtTimeArrived" runat="server" CssClass="form-control default-date-picker-ticket" placeholder="Arrived Date" DBColumnName="WAKTU_TIBA" SPParameterName="p_waktu_tiba"  DataType="Datetime" BindType="Both" Format="dd/MM/yyyy"></cc1:XUITextBox>
            ...
            <div class="row">   
                    <div class="col-sm-6" ID="HNM" runat="server">
                      ...
                      <div class="col-sm-6" ID="CTY" runat="server">
                        <div class="form-group">
                            <label class="col-sm-4">City *</label>    
                            <div class="col-sm-6">
                                <cc1:XUITextBox ID="txtCity" runat="server"  CssClass="form-control" placeholder="Hotel City" DBColumnName="NAMA_MASKAPAI" SPParameterName="p_nama_maskapai"  DataType="String" BindType="Both" ></cc1:XUITextBox>
            ...
            <div class="row">  
                     <div class="col-sm-6" ID="CID" runat="server">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <cc1:XUITextBox ID="txtCheckIndate" runat="server" CssClass="form-control default-date-picker-ticket" placeholder="Check In Date" DBColumnName="CHECK_IN" SPParameterName="p_check_in"  DataType="Datetime" BindType="Both" Format="dd/MM/yyyy"></cc1:XUITextBox>
                     ...
                     <div class="col-sm-6" ID="CKS" runat="server">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <cc1:XUITextBox ID="txtCheckOutdate" runat="server" CssClass="form-control default-date-picker-ticket" placeholder="Check Out Date" DBColumnName="CHECK_OUT" SPParameterName="p_check_out"  DataType="Datetime" BindType="Both" Format="dd/MM/yyyy"></cc1:XUITextBox>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <cc1:XUITextBox ID="txtRemarks" runat="server" CssClass="form-control" placeholder="Remarks" DBColumnName="REMARKS" MaxLength="400" SPParameterName="p_remarks" DataType="String" BindType="Both" TextMode="MultiLine"></cc1:XUITextBox>
