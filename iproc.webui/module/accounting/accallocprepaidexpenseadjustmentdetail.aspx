<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/iproc.master" CodeFile="accallocprepaidexpenseadjustmentdetail.aspx.cs" Inherits="module_accounting_accallocprepaidexpenseadjustmentdetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">
    <section class="panel">
        <header class="panel-heading">
            <span>Prepaid Expense Adjustment Detail  Info</span>
        </header>
