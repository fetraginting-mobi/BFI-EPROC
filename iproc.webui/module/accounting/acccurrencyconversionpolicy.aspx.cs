...
public partial class module_accounting_acccurrencyconversionpolicy : BasePage
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Shared.ShowSuccessGritter(this, string.Format("acccurrencyconversionpolicy.aspx?action=edit&id={0}", lblID.Text));
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
    ...
    {
        Response.Redirect("acccurrencyconversionpolicylist.aspx");
    }
