<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/iproc.master" CodeFile="accallocprepaidexpensedetail.aspx.cs" Inherits="module_accounting_accallocprepaidexpensedetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">
    <section class="panel">
        <header class="panel-heading">
            <span> Allocation Prepaid Expense Detail Info</span>
        </header>
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <cc1:XUILinkButton RoleCode="R12000168E" ID="btnSaveDetail" runat="server" CssClass="btn btn-primary" OnClick="btnSaveDetail_Click" ValidationGroup="allocdetail"><i class="icon-save"></i>  Save</cc1:XUILinkButton>
                     ...
                     <div class="row">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3">COA No *</label>
                                <asp:RequiredFieldValidator ID="rfvCoaNo" runat="server" ErrorMessage="Please Fill COA No" ControlToValidate="txtACCNo" Display="Dynamic" ValidationGroup="allocdetail"></asp:RequiredFieldValidator>
                            <div class="col-sm-9">
                            ...
                            <cc1:XUITextBox ID="txtAllocation_Id" runat="server" CssClass="form-control"  DBColumnName="ALLOCATION_ID" SPParameterName="p_allocation_id" DataType="String" BindType="Both" Width="250px" Style="display:none"></cc1:XUITextBox>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvdescription" runat="server" ControlToValidate="txtDescription"
                                        ErrorMessage="Please Fill Description" ValidationGroup="allocdetail">
                                    </asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator ID="revDescription" runat="server" ErrorMessage="Format Invalid!" ControlToValidate="txtDescription" ValidationGroup="allocdetail" ValidationExpression="^([\sA-Za-z0-9]+)$" Display="Dynamic"></asp:RegularExpressionValidator>  
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvDC" runat="server" ControlToValidate="rblDC"
                                        ErrorMessage="Please choose this field." ValidationGroup="allocdetail">
                                    </asp:RequiredFieldValidator>
                                </div>
                            </div>                            
                        </div>
