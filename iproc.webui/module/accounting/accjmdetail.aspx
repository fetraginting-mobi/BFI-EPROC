<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="accjmdetail.aspx.cs" Inherits="module_accounting_accjmdetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">
    <section class="panel">
        <header class="panel-heading">
            <span>Jurnal Memorial Detail Info</span>
        </header>
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-12">
                    <cc1:XUILinkButton RoleCode="R12000080E" ID="btnSave" runat="server" CssClass="btn btn-primary" OnClick="btnSave_Click"><i class="icon-save"></i>  Save</cc1:XUILinkButton>
            ...
            <ContentTemplate>
                ...
                <div class="col-sm-6">
                    <div class="col-sm-12">
                        ...
                        <cc1:XUILabel ID="lblJmNo" runat="server" DBColumnName="JM_NO" SPParameterName="p_jm_no" DataType="String" BindType="Both" Text="------"></cc1:XUILabel>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <cc1:XUIRadioButtonList ID="rblDebitOrCredit" runat="server" DBColumnName="DEBIT_OR_CREDIT" SPParameterName="p_debit_or_credit" DataType="String" BindType="Both" RepeatDirection="Horizontal">
                                <asp:ListItem Value="D" Text="  Debit&nbsp&nbsp" Selected="True"></asp:ListItem>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <cc1:XUITextBox ID="txtRate" runat="server" CssClass="form-control" placeholder="Exch Rate" DBColumnName="EXCH_RATE" SPParameterName="p_exch_rate"  DataType="Number" Format="N2" MaxLength="12" BindType="Both"></cc1:XUITextBox>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <asp:RegularExpressionValidator ID="revDebitAmount" runat="server" ErrorMessage="Format Invalid!" ControlToValidate="txtOrigAmount" ValidationExpression="[0-9 .,/()]*[0-9 .,/()]" Display="Dynamic"></asp:RegularExpressionValidator>  
                        </div>
                    </div>                            
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <cc1:XUITextBox ID="txtBaseCurr" runat="server" CssClass="form-control" placeholder="Currency" Enabled="false" DBColumnName="BASE_CURRENCY" SPParameterName="p_base_currency" MaxLength="3" DataType="String" BindType="Both"></cc1:XUITextBox>
                        </div>
                        <div class="col-sm-4">
                            <cc1:XUITextBox ID="txtBbaseAmount" runat="server" CssClass="form-control" placeholder="Base Amount" DBColumnName="BASE_AMOUNT" SPParameterName="p_base_amount" MaxLength="18" DataType="Number" Format="N2" BindType="Both"  Enabled="false" ></cc1:XUITextBox>
                        </div>
                    </div>                            
                </div>
                <div class="col-sm-6">
