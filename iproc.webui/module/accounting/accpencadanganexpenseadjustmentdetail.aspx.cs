...
public partial class module_accounting_accpencadanganexpensedetail : BasePage
{
    private static string TABLE_NAME = "PENCADANGAN_PREPAID_EXPENSE_ADJUSTMENT_DETAIL";
    ...
    private void SaveDataDetail()
    {
        ...
        try
        {
            ...
            Shared.ShowSuccessGritter(this, string.Format("accpencadanganexpensedetail.aspx?action=edit&id={0}&codebarcode={1}", lblID.Text, Request.Params["codebarcode"]));
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
