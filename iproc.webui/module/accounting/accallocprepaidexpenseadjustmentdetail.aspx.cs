...
public partial class module_accounting_accallocprepaidexpenseadjustmentdetail : BasePage
{
    private static string TABLE_NAME = "PREPAID_EXPENSE_ADJUSTMENT_DETAIL";
    ...
    private void SaveDataDetail()
    {
        ...
        try
        {
            ...
            Shared.ShowSuccessGritter(this, string.Format("accallocprepaidexpenseadjustmentdetail.aspx?action=edit&id={0}&codebarcode={1}", lblID.Text, Request.Params["codebarcode"]));
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
