<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/iproc.master" CodeFile="accallocprepaidadjustmentdetail.aspx.cs" Inherits="module_accounting_accallocprepaidadjustmentdetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">
    <section class="panel">
        <header class="panel-heading">
            <span> Allocation Prepaid Adjustment Detail Info</span>
        </header>
