...
public partial class module_accounting_accauditheader : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            //btnReject.Attributes["href"] = String.Format("javascript:fnShowApprovalDialog('../../approval/generic.aspx?code=APP0054&parc_object_id={0}');", lblAuditNo.ClientID);
            btnPost.Attributes["href"] = String.Format("javascript:fnShowApprovalDialog('../../approval/generic.aspx?code=APP0091&parc_object_id={0}&parc_object_branch={1}');", lblAuditNo.ClientID, lblbranch.ClientID);
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            if (Request.Params["action"].Equals("add"))
            {
                ...
                lblAuditNo.Text = iNextID;
            }
            else
                _dal.Update(TABLE_NAME, _ht);

            Shared.ShowSuccessGritter(this, string.Format("accauditheader.aspx?action=edit&auditno={0}", lblAuditNo.Text));
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
    ...
    private void CancelData()
    {
        ...
        try
        {
            ...
            _ht["p_audit_no"] = Request.Params["auditno"];
            _dal.ExecRawSP("xsp_acc_audit_header_cancel", _ht);
    ...
    private void PrintData()
    {
        ...
        try
        {
            ...
            _ht["p_audit_no"] = Request.Params["auditno"];
            _dal.ExecRawSP("xsp_acc_audit_header_print", _ht);
    ...
    private void ViewJurnalData()
    {
        ...
        try
        {
            ...
            _dal.ExecRawSP("xsp_acc_audit_header_view_jurnal", _ht);
    ...
    {
        Response.Redirect("accAuditheaderlist.aspx");
    }
    ...
    //    htParams["p_audit_no"] = lblAuditNo.Text;
    //    string sFilename = "";

    //    sFilename = Shared.ExecuteReport(this, "RPT_JURNAL_MEMORIAL_LIST", htParams, CrystalDecisions.Shared.ExportFormatType.PortableDocFormat);
    ...
    private void BindDataDetail()
    {
        ...
        try
        {
            ...
            _ht["p_audit_no"] = lblAuditNo.Text;
    ...
    {
        Response.Redirect("accauditdetail.aspx?action=add&auditno=" + lblAuditNo.Text);
    }
    ...
    {
        Response.Redirect("accauditdetail.aspx?action=edit&id=" + gvwListDetail.SelectedDataKey[0].ToString() + "&auditno=" + lblAuditNo.Text);
    }
    ...
    protected void gvwListDetail_OnRowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            dBaseCr = dBaseCr + decimal.Parse(e.Row.Cells[5].Text);
            dBaseDb = dBaseDb + decimal.Parse(e.Row.Cells[6].Text);
            dOrigCr = dOrigCr + decimal.Parse(e.Row.Cells[8].Text);
            dOrigDb = dOrigDb + decimal.Parse(e.Row.Cells[9].Text);
        }
        else if (e.Row.RowType == DataControlRowType.Footer)
        {
            e.Row.Cells[6].Text = dBaseDb.ToString("N2");
            e.Row.Cells[5].Text = dBaseCr.ToString("N2");
            e.Row.Cells[9].Text = dOrigDb.ToString("N2");
