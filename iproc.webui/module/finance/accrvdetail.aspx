<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="accrvdetail.aspx.cs" Inherits="module_finance_accrvdetail" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">
    <section class="panel">
        <header class="panel-heading">
            <span>Receipt Voucher Detail Info</span>
        </header>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
              <ContentTemplate>
                ...
                <div class="col-sm-6">
                    <div class="col-sm-12">
                        <cc1:XUILabel ID="lblStatus" runat="server" DBColumnName="STATUS" SPParameterName="p_rv_status" DataType="String" BindType="Both" Text="------"></cc1:XUILabel>
             ...
             <%--(+)End Neng - 21/10/2016 20:35:27 - penambahan division dan department--%>                 
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rfvOrigAmount" runat="server" ErrorMessage="*" ControlToValidate="txtOrigAmount" Display="Dynamic"></asp:RequiredFieldValidator>
                        <div class="col-sm-2">
                            <cc1:XUITextBox ID="txtCurrencyCode" runat="server" CssClass="form-control" placeholder="" DBColumnName="CURRENCY_CODE" SPParameterName="p_currency_code" MaxLength="18" DataType="String" BindType="Both" Enabled="false"></cc1:XUITextBox>
                        </div>
                        <div class="col-sm-5">    
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <cc1:XUITextBox ID="txtExchRate" runat="server" CssClass="form-control" placeholder="Exch Rate" DBColumnName="EXCH_RATE" SPParameterName="p_exch_rate" MaxLength="18" DataType="Number" BindType="Both" Format="N2" Enabled="false"></cc1:XUITextBox>
                        </div>
                    </div>                            
                </div> 
             </div>
