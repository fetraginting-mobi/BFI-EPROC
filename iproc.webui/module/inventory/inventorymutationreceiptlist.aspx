<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="inventorymutationreceiptlist.aspx.cs" Inherits="module_inventory_inventorymutationreceiptlist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">
    ...
    <header class="panel-heading">
        ...
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8">
                    <cc1:XUILinkButton ID="btnSave" RoleCode="R60000115E" runat="server" CssClass="btn btn-primary" style="display:none" OnClick="btnSave_Click"><i class="icon-save"></i></cc1:XUILinkButton>
                    ...
                    <label class="col-sm-2">Branch</label>
                        <div class="col-sm-5">
                          <cc1:XUIDropDownList ID="ddlBranch" runat="server" CssClass="form-control" DBColumnName="BRANCH_CODE" SPParameterName="p_branch_code" DataType="String" BindType="Both" AutoPostBack="true" OnSelectedIndexChanged="ddlBranch_SelectedIndexChanged" ></cc1:XUIDropDownList>
                           <cc1:XUITextBox ID="txtbranch" runat="server" CssClass="form-control" style="display:none" placeholder="Remarks" DBColumnName="REMARKS" SPParameterName="p_remarks" DataType="String" BindType="None" Height="58px"></cc1:XUITextBox>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
                    ...
                    <label class="col-sm-3"></label>
                        <div class="col-sm-5">
                            <cc1:XUIDropDownList ID="ddlStatus" Width="200px" runat="server" CssClass="form-control" SPParameterName="p_status" DataType="String" BindType="Both" AutoPostBack="true" style="display:none" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged"></cc1:XUIDropDownList>
                        </div>
                    </div>
                </div> 
            </div>
