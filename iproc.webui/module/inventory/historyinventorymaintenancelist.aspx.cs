...
public partial class module_inventory_historyinventorymaintenancelist : BasePageList
{
    ...
    private void BindData()
    {
        ...
        try
        {
            ...
            gvwList.DataSource = _dal.GetRows("","xsp_inventory_history_maintenance_list_getrows", _ht);
            gvwList.DataBind();
        }
        catch (Exception ex)
        {
    ...
    protected override void SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("inventoryhistorymaintenance.aspx?action=edit&codebarcode=" + gvwList.SelectedDataKey[0].ToString());
    }
