<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="inventoryretrunheader.aspx.cs" Inherits="module_inventory_inventoryretrunheader" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Stock Return Info</span>
        </header>
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-12">
                    <cc1:XUILinkButton ID="btnSave" RoleCode="R60000140C" runat="server" CssClass="btn btn-primary" OnClick="btnSave_Click"><i class="icon-save"></i>  Save</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnPost" RoleCode="R60000140O" runat="server" CssClass="btn btn-success" ><i class="icon-envelope"></i>  Post</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnReject" RoleCode="R60000140O" runat="server" CssClass="btn btn-danger" CausesValidation="false"><i class="icon-remove"></i>  Cancel</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnPrint" RoleCode="R60000140P" runat="server" CssClass="btn btn-primary" OnClick="btnPrint_Click" CausesValidation="false"><i class="icon-print"></i>  Print</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnCancel" RoleCode="R60000140O" runat="server" CssClass="btn btn-danger" OnClick="btnCancel_Click" CausesValidation="false"><i class="icon-remove"></i>  Cancel</cc1:XUILinkButton>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <cc1:XUITextBox ID="txtRetrunDate" runat="server" CssClass="form-control default-date-picker" placeholder="Retrun Date" DBColumnName="RETRUN_DATE" SPParameterName="p_retrun_date" MaxLength="10" DataType="DateTime" BindType="Both" Format ="dd/MM/yyyy"></cc1:XUITextBox>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:LinkButton runat="server" ID="btnLookUpIssueCode" class="btn btn-primary" data-toggle="modal" CausesValidation="false"><i class="icon-table"></i></asp:LinkButton>
                                    <cc1:XUITextBox ID="txtIssueCode" style="display:none" runat="server" CssClass="form-control" DBColumnName="II_CODE" SPParameterName="p_ii_code" MaxLength="10" DataType="String" BindType="Both"></cc1:XUITextBox>
                                    <cc1:XUILabel ID="lblIssueCode" runat="server"  DBColumnName="ISSUE_CODE" DataType="String" BindType="DBToUIOnly" Text="--"></cc1:XUILabel>
                                    <asp:RequiredFieldValidator ID="rfvIssueCode" runat="server" ErrorMessage="Required Field!" ControlToValidate="txtIssueCode" Display="Dynamic"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                        </div>         
                    </div>
    ...
    <section class="panel">
        ...
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8">
                    <cc1:XUILinkButton ID="btnSaveDetail" RoleCode="R60000140C" runat="server" CssClass="btn btn-primary" OnClick="btnSaveDetail_Click" ><i class="icon-save"></i>  Save</cc1:XUILinkButton> <!-- R07000002E role code sebelumnya -->
                    ...
                    AllowPaging="true" PageSize="10" DataKeyNames="ID"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="New">
                                <ItemStyle Width="10%" HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:RadioButton ID="rblNew" SPParameterName="p_is_new" runat="server" RepeatDirection="Horizontal" GroupName="rblReturn" />
                                    <%--<asp:CheckBox ID="chbNew" runat="server" DBColumnName="IS_NEW" SPParameterName="p_is_new" DataType="String" BindType="Both" />--%>                                 
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Repair">
                                <ItemStyle Width="10%" HorizontalAlign="Left" />
                                <ItemTemplate>
                                    <asp:RadioButton ID="rblRepair" SPParameterName="p_is_repair" runat="server" RepeatDirection="Horizontal" GroupName="rblReturn" />
                                    <%--<asp:CheckBox ID="chbRepair" runat="server" DBColumnName="IS_REPAIR" SPParameterName="p_is_repair" DataType="String" BindType="Both" />--%>                                    
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="QUANTITY_ISSUE" HeaderText="Quantity Issue" >
                                <ItemStyle Width="10%" HorizontalAlign="Right" />
                            </asp:BoundField>
