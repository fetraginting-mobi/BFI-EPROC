<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="inventorymutationheader.aspx.cs" Inherits="module_inventory_inventorymutationheader" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">   
    <section class="panel">
        ...
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-12">
                    <cc1:XUILinkButton ID="btnSave" RoleCode="R60000110E" runat="server" CssClass="btn btn-primary" OnClick="btnSave_Click"><i class="icon-save"></i>  Save</cc1:XUILinkButton>
                    <cc1:XUILinkButton RoleCode="R60000110O" ID="btnApprovalTiered" runat="server" CssClass="btn btn-success" Visible="false"><i class="icon-ok"></i>  Approval</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnPost" RoleCode="R60000110O" runat="server" CssClass="btn btn-success" ><i class="icon-envelope"></i>  Post</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnReject" RoleCode="R60000110O" runat="server" CssClass="btn btn-danger" CausesValidation="false"><i class="icon-remove"></i>  Cancel</cc1:XUILinkButton>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <cc1:XUILabel ID="lblAmount" runat="server" SPParameterName="p_object_amount" DataType="Number" Text="100" style="display:none;" BindType="UIToDBOnly"></cc1:XUILabel>
                                  <cc1:XUITextBox ID="txtCodeBarcode" style="display:none" runat="server"  CssClass="form-control" DBColumnName="CODE_BARCODE" DataType="String" BindType="DBToUIOnly"></cc1:XUITextBox>
                                  <cc1:XUITextBox ID="txtBranch" runat="server" CssClass="form-control" placeholder="Remarks" DBColumnName="REMARKS" SPParameterName="p_remarks" MaxLength="400" DataType="String" style="display:none;" BindType="None"></cc1:XUITextBox>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                 <asp:UpdatePanel ID="UpC" runat="server">
                                        <ContentTemplate>
                                    <%--<cc1:XUILabel ID="lblBranch" runat="server"  DBColumnName="DESCRIPTION" DataType="String" BindType="DBToUIOnly" Text="--"></cc1:XUILabel> --%>
                                    <cc1:XUIDropDownList ID="ddlToBranch" runat="server" CssClass="form-control" DBColumnName="TO_BRANCH" SPParameterName="p_to_branch" DataType="String"  AutoPostBack= "true" BindType="Both" ></cc1:XUIDropDownList>
                                    <cc1:XUILabel ID="lblToBranch" runat="server"  DBColumnName="to_branch_desc" DataType="String" BindType="DBToUIOnly" Text="--" style="display:none;"></cc1:XUILabel>
                                    </ContentTemplate>
                                  </asp:UpdatePanel>
                                </div>
                            </div>                             
                         ...
                         <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <cc1:XUITextBox ID="txtFromLocationCode" runat="server" style="display:none"  CssClass="form-control" DBColumnName="FROM_LOCATION" SPParameterName="p_from_location" DataType="String" BindType="Both"></cc1:XUITextBox>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">  
                                    ...
                                    <cc1:XUITextBox ID="txtToLocationCode" runat="server" style="display:none"  CssClass="form-control" DBColumnName="TO_LOCATION" SPParameterName="p_to_location" DataType="String" BindType="Both"></cc1:XUITextBox>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <cc1:XUITextBox ID="txtFromLotCode" style="display:none" runat="server"  CssClass="form-control" DBColumnName="FROM_LOT" SPParameterName="p_from_lot" DataType="String" BindType="Both"></cc1:XUITextBox>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <cc1:XUITextBox ID="txtToLotCode" style="display:none" runat="server"  CssClass="form-control" DBColumnName="TO_LOT" SPParameterName="p_to_lot" DataType="String" BindType="Both"></cc1:XUITextBox>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <cc1:XUITextBox ID="txtFromRakCode" style="display:none" runat="server"  CssClass="form-control" DBColumnName="FROM_RAK" SPParameterName="p_from_rak" DataType="String" BindType="Both"></cc1:XUITextBox>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <cc1:XUITextBox ID="txtToRakCode" style="display:none" runat="server"  CssClass="form-control" DBColumnName="TO_RAK" SPParameterName="p_to_rak" DataType="String" BindType="Both"></cc1:XUITextBox>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <cc1:XUITextBox ID="txtFromSlotCode" style="display:none" runat="server"  CssClass="form-control" DBColumnName="FROM_SLOT" SPParameterName="p_from_slot" DataType="String" BindType="Both"></cc1:XUITextBox>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <cc1:XUITextBox ID="txtToSlotCode" style="display:none" runat="server"  CssClass="form-control" DBColumnName="TO_SLOT" SPParameterName="p_to_slot" DataType="String" BindType="Both"></cc1:XUITextBox>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <cc1:XUITextBox ID="txtExpeditionDescription" runat="server" CssClass="form-control" placeholder="Description" DBColumnName="EXPEDITION_DESCRIPTION" SPParameterName="p_expedition_description" MaxLength="200" DataType="String" BindType="Both" TextMode="MultiLine"></cc1:XUITextBox>
                                    <asp:RequiredFieldValidator ID="rfvExpeditionDescription" runat="server" ErrorMessage="Required Field!" ControlToValidate="txtExpeditionDescription" Display="Dynamic"></asp:RequiredFieldValidator>
                                    <asp:RegularExpressionValidator runat="server" ID="valInput" ControlToValidate="txtExpeditionDescription" ValidationExpression="^[\s\S]{0,50}$" ErrorMessage="Exceed maximum length 200" Display="Dynamic"></asp:RegularExpressionValidator>
                                </div>
                            </div>                            
                        </div> 
                        <div class="col-sm-6">
  ...
  <section class="panel">
        <header class="panel-heading tab-bg-dark-navy-blue">
            <ul class="nav nav-tabs nav-justified">       
              <li class="active">
                  <a href="#mutation" id="mutdetail" onclick="javascript:fnSetTab('mutdetail');" data-toggle="tab" style="padding-bottom:28px">
                      Mutation Detail 
                  </a>
              </li>
              
              <li class="">
                  <a href="#expedition" id="mutatexpedition" onclick="javascript:fnSetTab('mutatexpedition');" data-toggle="tab" style="padding-bottom:28px">
                      Mutation Expedition
                  </a>
              </li> 
          </ul>
            ...
            <div class="tab-content tasi-tab">
                <div class="tab-pane active" id="mutation">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-sm-8">
                                 <cc1:XUILinkButton ID="btnAddAdDep" RoleCode="R80000010E" runat="server" CssClass="btn btn-primary"  data-toggle="modal" CausesValidation="false"><i class="icon-plus"></i>  Add</cc1:XUILinkButton>
                                ...
                                <cc1:XUILinkButton ID="btnDeleteRequestDetail" RoleCode="R80000010E" runat="server"  CssClass="btn btn-danger" OnClick="btnDeleteRequestDetail_Click" CausesValidation="false"><i class="icon-trash"></i>  Delete</cc1:XUILinkButton>
                            </div>
                            <div class="col-sm-4">
            ...
            <asp:UpdatePanel ID="upd" runat="server">
                    ...
                    AllowPaging="true" PageSize="10" DataKeyNames="ID"
                        ...
                        <Columns>
                          ...
                          <%--  <asp:BoundField DataField="QUANTITY" HeaderText="Quantity" DataFormatString="{0:N0}">
                             ...
                             <asp:BoundField DataField="RECEIPT_DATE" HeaderText="Receive Date" DataFormatString="{0:dd/MM/yyyy}">
                                <ItemStyle Width="10%" HorizontalAlign="Right"  />
                            </asp:BoundField>
                ...
                <div class="tab-pane" id="expedition">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-sm-8 ">
                                <cc1:XUILinkButton RoleCode="R60000110E" ID="btnAddTOP" runat="server" CssClass="btn btn-primary"   OnClick="btnAddTOP_Click"><i class="icon-plus"></i>  Create</cc1:XUILinkButton>
                                <cc1:XUILinkButton RoleCode="R60000110E" ID="btnDeleteTOP" runat="server" CssClass="btn btn-danger"  OnClick="btnDeleteTOP_Click"><i class="icon-trash"></i>  Delete</cc1:XUILinkButton>
                            </div>
                            <div class="col-sm-4 ">
