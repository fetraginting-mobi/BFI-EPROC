...
public partial class module_inventory_inventoryentryheaderlist : BasePageList
{
    private static string TABLE_NAME_HEADER = "INVENTORY_ENTRY_HEADER";

    protected void Page_Init(object sender, EventArgs e)
    {
        PAGE_LIST = "INVENTORY_ENTRY_HEADER";
        NEXT_PAGE = "inventoryentryheader.aspx";
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            Shared.BindGeneralSubCodeByTransflagCode(ddlStatus, "IE");
            BindData();
    ...
    {
        Response.Redirect("inventoryentryheader.aspx?action=add");
    }
    ...
    protected override void SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect("inventoryentryheader.aspx?action=edit&codebarcode=" + gvwList.SelectedDataKey[0].ToString());
    }
