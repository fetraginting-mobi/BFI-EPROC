<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="inventoryreturnsupplierheaderlist.aspx.cs" Inherits="module_inventory_inventoryreturnsupplierheaderlist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    ...
    <header class="panel-heading">
          <span>Supplier Return List </span>
        </header>
                ...
                <ContentTemplate>
                    ...
                    AllowPaging="true" PageSize="10" DataKeyNames="CODE_BARCODE"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="RETURN_DATE" HeaderText="Date" DataFormatString="{0:dd/MM/yyyy}">
                                <ItemStyle Width="15%" HorizontalAlign="Center" />
                            </asp:BoundField>
                             <asp:BoundField DataField="GRN_CODE" HeaderText="GRN No.">
                                <ItemStyle Width="20%" HorizontalAlign="Center"/>
                            </asp:BoundField>
