...
public partial class module_inventory_inventorymaintenanceheaderlist : BasePage
{
    private static string TABLE_NAME = "INVENTORY_MAINTENANCE";

    protected void Page_Init(object sender, EventArgs e)
    {
        PAGE_LIST = "INVENTORY_MAINTENANCE";
        NEXT_PAGE = "inventorymaintenance.aspx";
    }
    ...
    {
        Response.Redirect("inventorymaintenance.aspx?action=add");
    }
    ...
    {
        Response.Redirect("inventorymaintenance.aspx?action=edit&id=" + gvwList.SelectedDataKey[0].ToString());
    }
