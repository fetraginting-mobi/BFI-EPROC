<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="documentreceiptheaderlist.aspx.cs" Inherits="module_inventory_documentreceiptheaderlist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">    
    <section class="panel">
        <header class="panel-heading">
            <span>Document Receipt List</span>
        </header>
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <cc1:XUILinkButton RoleCode="R60000143C" ID="btnDelete" runat="server" CssClass="btn btn-danger" OnClick="btnDelete_Click"><i class="icon-trash"></i>  Delete</cc1:XUILinkButton>
                </div>
                <div class="col-sm-4"> 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TRX_DATE" HeaderText="Date" DataFormatString="{0:dd/MM/yyyy}">
                             ...
                             <asp:BoundField DataField="RECEIVE_LOCATION" HeaderText="Receive Location">
                              ...
                              <asp:BoundField DataField="MOVED_LOCATION" HeaderText="Moved Location">
                                <ItemStyle Width="10%" HorizontalAlign="Left"  />
                            </asp:BoundField>
                             <asp:BoundField DataField="FLOOR" HeaderText="Lantai">
                                <ItemStyle Width="5%" HorizontalAlign="Left"  />
                            </asp:BoundField>
                            <asp:BoundField DataField="SHIPPER" HeaderText="Shipper">
                                <ItemStyle Width="10%" HorizontalAlign="Left"  />
                            </asp:BoundField>
                             <asp:BoundField DataField="status" HeaderText="Document Status">
                                <ItemStyle Width="5%" HorizontalAlign="Left"  />
                            </asp:BoundField>
