<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="inventorymutationuploadlog.aspx.cs" Inherits="module_inventory_inventorymutationuploadlog" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        ...
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8 ">
                    <cc1:XUILinkButton ID="btnCancel"  runat="server" CssClass="btn btn-danger" OnClientClick="window.parent.fnHideGenericScreen(); return false;" CausesValidation="false"><i class="icon-arrow-left"></i>  Back</cc1:XUILinkButton>
                </div>
                <div class="col-sm-4 ">
