<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="inventoryviewstock.aspx.cs" Inherits="module_inventory_inventoryviewstock" %>
           ...
           <div class="row">
                <div class="col-sm-5">
                    ...
                    <label class="col-sm-4">Location</label>
                        <div class="col-sm-8">
                          <cc1:XUIDropDownList ID="ddlLocation" runat="server" CssClass="form-control" DBColumnName="LOCATION_CODE" SPParameterName="p_location_code" DataType="String" BindType="Both" AutoPostBack="true" OnSelectedIndexChanged="ddlLocation_SelectedIndexChanged"></cc1:XUIDropDownList>
                        </div>
                    </div>
                  </div>
                    <div class="col-sm-5">
