<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="inventoryreceiptheaderlist.aspx.cs" Inherits="module_inventory_inventoryrequestheaderlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">    
    <section class="panel">
        <header class="panel-heading">
          <span>Inventory Receipt List</span>
        </header>
                ...
                <ContentTemplate>
                    ...
                    AllowPaging="true" PageSize="10" DataKeyNames="CODE_BARCODE"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CODE" HeaderText="Inventory Receipt No.">
                                <ItemStyle Width="30%" HorizontalAlign="Center"  />
                            </asp:BoundField>
                            <asp:BoundField DataField="RECEIPT_DATE" HeaderText="Date" DataFormatString="{0:dd/MM/yyyy}">
                                <ItemStyle Width="15%" HorizontalAlign="Center"  />
                            </asp:BoundField>
                            <asp:BoundField DataField="LOCATION_DESCRIPTION" HeaderText="Location">
