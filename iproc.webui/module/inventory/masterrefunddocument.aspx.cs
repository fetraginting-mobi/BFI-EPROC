...
public partial class module_commonmst_masterrefunddocument : BasePage
{
    private static string TABLE_NAME = "REFUND_DOCUMENT";
    ...
    private void SaveData()
    {
        ...
        try
        {
            ...
            _ht["p_refund_code"] = Request.Params["codebarcode"];
            ...
            Shared.ShowSuccessGritter(this, string.Format("refundinventoryamortizationheader.aspx?action=edit&codebarcode={0}", Request.Params["codebarcode"]));
        }
        catch (Exception ex)
        {
            Shared.ShowErrorDialog(this, ex);
    ...
    {
        Response.Redirect("refundinventoryamortizationheader.aspx?action=edit&codebarcode=" + Request.Params["codebarcode"]);
    }
}