<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="inventoryrequestmutationheaderlist.aspx.cs" Inherits="module_inventory_inventoryrequestmutationheaderlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server"> 
    <section class="panel">
        <header class="panel-heading">
          <span>Inventory Mutation Request List</span>
        </header>
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8">
                   <cc1:XUILinkButton RoleCode="R60000105C" ID="btnAdd" runat="server" CssClass="btn btn-primary" OnClick="btnAdd_Click" style="display:none" ><i class="icon-plus" style="display:none" ></i>  Create</cc1:XUILinkButton>
                    <cc1:XUILinkButton RoleCode="R60000105D" ID="btnDelete" runat="server" CssClass="btn btn-danger" OnClick="btnDelete_Click"><i class="icon-trash"></i>  Delete</cc1:XUILinkButton>
                </div>
                <div class="col-sm-4">  
