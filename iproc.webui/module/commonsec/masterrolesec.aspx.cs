...
public partial class module_commonsec_masterrolesec : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            Shared.BindApplicationCode(ddlApplicationCode);
            ddlApplicationCode.SelectedValue = "PR";
    ...
    {
        Response.Redirect("masterroleseclist.aspx");
    }
}
