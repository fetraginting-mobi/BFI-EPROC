<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="mastergroupseclist.aspx.cs" Inherits="module_commonsec_mastergroupseclist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Group Security List</span>
        </header>
        <div class="panel-heading">
            <div class="row">
                <div class="col-sm-8 ">
                    <cc1:XUILinkButton ID="btnAddGroup" RoleCode="R40000020C" runat="server" CssClass="btn btn-primary" OnClick="btnAddGroup_Click"><i class="icon-plus"></i>  Create</cc1:XUILinkButton>
                    <cc1:XUILinkButton ID="btnDeleteGroup" RoleCode="R40000020D" runat="server" CssClass="btn btn-danger" OnClick="btnDeleteGroup_Click"><i class="icon-trash"></i>  Delete</cc1:XUILinkButton>
                </div>
                <div class="col-sm-4 ">
