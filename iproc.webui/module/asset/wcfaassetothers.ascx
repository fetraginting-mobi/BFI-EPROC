<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wcfaassetothers.ascx.cs" Inherits="module_asset_wcfaassetothers" %>

<%@ Register Assembly="MPF23.XUI" Namespace="MPF23.XUI.Control" TagPrefix="cc1" %>

<section class="panel">
    <%--<header class="panel-heading">
      <span>Asset Others Info</span>
    </header>--%>        
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-12">
                <asp:LinkButton ID="btnSave" runat="server" CssClass="btn btn-primary" OnClick="btnSave_Click" CausesValidation="true" ValidationGroup="Others"><i class="icon-save"></i>  Save</asp:LinkButton>
            </div>
        </div>
    </div>
    <div class="panel-body form-horizontal"> <%--(+) Start - 2015/12/10 - 10:11 - Adi -  mengatur kolom menjadi total ukuran 12--%>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        ...
                        <cc1:XUITextBox ID="txtMerk" style="display:none" runat="server" CssClass="form-control" DBColumnName="ASSET_MERK_CODE" SPParameterName="p_asset_merk_code" MaxLength="8" DataType="Integer" BindType="None"></cc1:XUITextBox>
          ...
          <div class="col-sm-6">
                ...
                <div class="col-sm-8">
                    <div class="input-group">
                        ...
                        <cc1:XUITextBox ID="txtModelCode" runat="server" CssClass="form-control" placeholder="Model Code" DBColumnName="ASSET_MODEL_CODE" SPParameterName="p_asset_model_code" MaxLength="10" DataType="String" BindType="None" ></cc1:XUITextBox>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row" style="display:none">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                             <asp:LinkButton runat="server" ID="btnLookUpType" class="btn btn-primary" data-toggle="modal" CausesValidation="false"><i class="icon-table"></i></asp:LinkButton>
                                <cc1:XUITextBox ID="txtType" style="display:none" runat="server" CssClass="form-control" DBColumnName="ASSET_TYPE_CODE" SPParameterName="p_asset_type_code" MaxLength="8" DataType="String" BindType="None"></cc1:XUITextBox>
             ...
             <div class="col-sm-6">
                <div class="form-group">
                    <label class="col-sm-4">Category Service</label>
                    ...
                    <div class="col-sm-8">
                        <cc1:XUITextBox ID="txtCategoryService" runat="server" CssClass="form-control" placeholder="Category Service" DBColumnName="CATEGORY_SERVICE" SPParameterName="p_category_service" MaxLength="50" DataType="String" BindType="Both" Width="250px"></cc1:XUITextBox>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row" style="display:none">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <cc1:XUITextBox ID="txtColour" runat="server" CssClass="form-control" placeholder="Colour" DBColumnName="COLOUR" SPParameterName="p_colour" MaxLength="50" DataType="String" BindType="None" Width="250px"></cc1:XUITextBox>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <cc1:XUILabel ID="lblMadeInId" runat="server" DBColumnName="MADE_IN" SPParameterName="p_made_in" DataType="String" BindType="Both" Text=""></cc1:XUILabel>
                    </div>
                </div>
            </div>
        </div>
        <div class="row" style="display:none">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <cc1:XUITextBox ID="txtInvoiceNo" runat="server" CssClass="form-control" placeholder="Invoice No" DBColumnName="INVOICE_NO" SPParameterName="p_invoice_no" DataType="String" MaxLength="50" BindType="None" Width="250px"></cc1:XUITextBox>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <cc1:XUITextBox ID="txtBuiltYear" runat="server" CssClass="form-control" placeholder="Built Year" DBColumnName="BUILT_YEAR" SPParameterName="p_built_year" MaxLength="4" DataType="String" BindType="None" Width="140px"></cc1:XUITextBox>
        ...
        <div class="row" style="display:none">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <%--<asp:RequiredFieldValidator ID="rfvChassisNumber" runat="server" ErrorMessage="*" ControlToValidate="txtChassisNumber" Display="Dynamic"></asp:RequiredFieldValidator>--%>
                    <div class="col-sm-8">
                        <cc1:XUITextBox ID="txtChassisNumber" runat="server" CssClass="form-control" placeholder="Chassis Number" DBColumnName="CHASSIS_NO" SPParameterName="p_chassis_no" MaxLength="50" DataType="String" BindType="None" Width="250px"></cc1:XUITextBox>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <cc1:XUITextBox ID="txtEngineNumber" runat="server" CssClass="form-control" placeholder="Engine Number" DBColumnName="ENGINE_NO" SPParameterName="p_engine_no" MaxLength="50" DataType="String" BindType="None" Width="250px"></cc1:XUITextBox>
                    </div>
                </div>
            </div>
        </div>
        <div class="row" style="display:none">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <cc1:XUITextBox ID="txtLocation" runat="server" CssClass="form-control" placeholder="City" DBColumnName="CITY_ID" SPParameterName="p_city_id" DataType="Integer" BindType="None" style="display:none"></cc1:XUITextBox>
                            ...
                            <cc1:XUITextBox ID="txtLocationDesc" CssClass="form-control" runat="server" DBColumnName="CITY_DESC" DataType="String" BindType="DBToUIOnly" Enabled="false" Width="250px"></cc1:XUITextBox> (<%--+) 2015/12/10 - 10:12- Adi -  mengubah label lookup menjadi textbox--%>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label class="col-sm-4">Remarks 2</label>
                    <div class="col-sm-8">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label class="col-sm-4">Remarks 3</label>
                    <div class="col-sm-8">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label class="col-sm-4">Remarks 4</label>
                    <div class="col-sm-8">
