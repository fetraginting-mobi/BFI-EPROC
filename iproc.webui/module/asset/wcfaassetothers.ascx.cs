...
public partial class module_asset_wcfaassetothers : System.Web.UI.UserControl
{
    private static string TABLE_NAME = "FA_ASSET_OTHERS";
    protected void Page_Load(object sender, EventArgs e)
    {
        //(+) Start - 2015/12/10 - 10:11 - Adi -  mengubah label lookup menjadi textbox
        ...
        //(+) END - 2015/12/10 - 10:11 - Adi -

        if (!Page.IsPostBack)
        {
            //Shared.BindMadeIn(ddlMadeIn); (-) 2016/01/18 -  14:43 - Gleen -
