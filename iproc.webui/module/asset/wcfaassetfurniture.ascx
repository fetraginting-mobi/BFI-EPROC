<%@ Control Language="C#" AutoEventWireup="true" CodeFile="wcfaassetfurniture.ascx.cs" Inherits="module_asset_wcfaassetfurniture" %>

<%@ Register Assembly="MPF23.XUI" Namespace="MPF23.XUI.Control" TagPrefix="cc1" %>

<section class="panel">
    <%--<header class="panel-heading">
      <span>Asset Furniture Info</span>
    </header> --%>       
    <div class="panel-heading">
        <div class="row">
            <div class="col-sm-12">
                <asp:LinkButton ID="btnSaveAssetFurniture" runat="server" CssClass="btn btn-primary" OnClick="btnSaveAssetFurniture_Click" CausesValidation="true" ValidationGroup="Furniture"><i class="icon-save"></i> Save</asp:LinkButton>
            </div>
        </div>
    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            ...
                            <cc1:XUITextBox ID="txtModelCode" runat="server" CssClass="form-control" placeholder="Model Code" DBColumnName="ASSET_MODEL_CODE" SPParameterName="p_asset_model_code" MaxLength="10" DataType="String" BindType="Both" ></cc1:XUITextBox>
                        </div>
                    </div>
                </div>
            </div>
