<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptoutstandingquotationlist.aspx.cs" Inherits="module_report_rptoutstandingquotationlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Outstanding Quotation List Report</span>
        </header>
