<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptinventoryissueperbranchlist.aspx.cs" Inherits="module_report_rptinventoryissueperbranchlist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Inventory Issue Per Branch List Report</span>
        </header>
