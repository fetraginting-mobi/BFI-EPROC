<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="goodreceiptnotereportlist.aspx.cs" Inherits="module_report_goodreceiptnotereportlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" runat="Server">    
    <section class="panel">
        <header class="panel-heading">
          <span>Good Receipt Note Report List</span>
        </header>
