<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptapinvoicelisttermin.aspx.cs" Inherits="module_report_rptapinvoicelisttermin" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>AP Invoice List Termin Report</span>
        </header>
