<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptgoodreceiptperdatelist.aspx.cs" Inherits="module_report_rptgoodreceiptperdatelist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Good Receipt Per Date List Report</span>
        </header>
