<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptapadvancelist.aspx.cs" Inherits="module_report_rptapadvancelist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>AP Advance List Report</span>
        </header>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="rfvddlBank" runat="server" ErrorMessage="*" ControlToValidate="ddlBank" Display="Dynamic"></asp:RequiredFieldValidator>
                                <div class="col-sm-6">
                                    <cc1:XUIDropDownList ID="ddlBank" runat="server" CssClass="form-control" SPParameterName="p_bank_code" BindType="Both" DataType="String" ></cc1:XUIDropDownList>  
                                </div>
                            </div>
                        </div>   
                    </div>
