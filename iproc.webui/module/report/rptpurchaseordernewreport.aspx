<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptpurchaseordernewreport.aspx.cs" Inherits="module_report_rptpurchaseordernewreport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Purchase Order New Report</span>
        </header>
                     ...
                     <div class="row">
                        <div class="col-sm-6">
                            ...
                            <label class="col-sm-3">Order Type</label>
                                <div class="col-sm-6">
                                    <cc1:XUIDropDownList ID="ddlOrder" runat="server" CssClass="form-control" SPParameterName="p_order_code" DataType="String" BindType="UItoDBOnly">
                                        <asp:ListItem Value="ALL">ALL</asp:ListItem>
                                        <asp:ListItem Value="NEW TRANSACTION">NEW TRANSACTION</asp:ListItem>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-3">Supplier</label>
                                <div class="col-sm-6">
                                    <cc1:XUIDropDownList ID="ddlSupplier" runat="server" CssClass="form-control" SPParameterName="p_supplier_code" BindType="Both" DataType="String" ></cc1:XUIDropDownList>
                                </div>
                            </div>                            
                        </div>
                    </div>                    
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <cc1:XUIDropDownList ID="ddlSearchBy" Width="200px" runat="server" CssClass="form-control" SPParameterName="p_search_by" DataType="String" BindType="Both">
                                        ...
                                        <asp:ListItem Value="PAYMENT BY">PAYMENT BY</asp:ListItem>
                                        <asp:ListItem Value="RECEIVE BY">RECEIVE BY</asp:ListItem>
