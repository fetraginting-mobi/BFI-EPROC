<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptinventorymutationreceiptlist.aspx.cs" Inherits="module_report_rptinventorymutationreceiptlist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Inventory Mutation Receipt List Report</span>
        </header>
                     ...
                     <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-3">Branch Receipt</label>
