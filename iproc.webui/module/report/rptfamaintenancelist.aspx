<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptfamaintenancelist.aspx.cs" Inherits="module_report_rptfamaintenancelist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span> Report FA Maintenance</span>
        </header>
                         ...
                         <div class="form-group">
                           ...
                           <div class="col-sm-6">
                              <asp:UpdatePanel ID="UpB" runat="server">
                                 ...
                                 <cc1:XUILabel ID="lblbranch" runat="server"  DBColumnName="P_BRANCH_CODE" DataType="String" BindType="DBToUIOnly" Text="--" style="display:none;"></cc1:XUILabel>
                                 </ContentTemplate>
                               </asp:UpdatePanel>
                            </div>
                         </div>
