<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptpurchaseorderperbranchlist.aspx.cs" Inherits="module_report_rptpurchaseorderperbranchlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Purchase Order Per Branch List Report</span>
        </header>
