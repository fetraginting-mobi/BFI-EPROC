<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptfixedassetlist.aspx.cs" Inherits="module_report_rptfixedassetlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Fixed Asset List Report</span>
        </header>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <cc1:XUIDropDownList ID="ddlStatus" runat="server" CssClass="form-control" SPParameterName="p_status" BindType="Both" DataType="String" >
                                     ...
                                     <asp:ListItem Value="SOLD INPROGRESS">SOLD IN PROGRESS</asp:ListItem>
