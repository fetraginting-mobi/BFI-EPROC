<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptinvoicesummarylist.aspx.cs" Inherits="module_report_rptinvoicesummarylist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Invoice Summary List Report</span>
        </header>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <label class="col-sm-3">Bill Type</label>
                                <div class="col-sm-6">
                                    <cc1:XUIDropDownList ID="ddlBillType" runat="server" CssClass="form-control" SPParameterName="p_bill_type" DataType="String" BindType="UItoDBOnly">
