<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptoutstandingpurchaseorderlist.aspx.cs" Inherits="module_report_rptoutstandingpurchaseorderlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Outstanding Purchase Order List Report</span>
        </header>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <cc1:XUIDropDownList ID="ddlCreditor" runat="server" CssClass="form-control" SPParameterName="p_creditor_code" BindType="Both" DataType="String" ></cc1:XUIDropDownList>  
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
