<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptquartalpenggunaanquantitylist.aspx.cs" Inherits="module_report_rptquartalpenggunaanquantitylist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Quartal Penggunaan Quantity List Report</span>
        </header>
