<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptdepositsewa.aspx.cs" Inherits="module_report_rptdepositsewa" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Sewa Ruko List Report</span>
        </header>
                     ...
                     <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <cc1:XUIDropDownList ID="ddlMonth" runat="server" CssClass="form-control" SPParameterName="p_month" DataType="String" BindType="UIToDBOnly" >
