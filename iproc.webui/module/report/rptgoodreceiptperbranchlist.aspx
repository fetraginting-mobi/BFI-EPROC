<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptgoodreceiptperbranchlist.aspx.cs" Inherits="module_report_rptgoodreceiptperbranchlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Good Receipt Note Per Branch List Report</span>
        </header>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="rfvddlSupplier" runat="server" ErrorMessage="*" ControlToValidate="ddlSupplier" Display="Dynamic"></asp:RequiredFieldValidator>
                                <div class="col-sm-6">
