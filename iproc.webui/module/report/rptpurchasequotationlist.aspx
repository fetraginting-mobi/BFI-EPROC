<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptpurchasequotationlist.aspx.cs" Inherits="module_report_rptpurchasequotationlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Purchase Quotation List Report</span>
        </header>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-3">Category Unit</label>
                                <div class="col-sm-6">
                                    <cc1:XUIDropDownList ID="ddlCategoryType" runat="server" CssClass="form-control" placeholder="Category" style="text-align:left!important" SPParameterName="p_category" MaxLength="30" DataType="String" BindType="Both"></cc1:XUIDropDownList>
                                </div>
                            </div>                            
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <label class="col-sm-3">Order Type</label>
                                <div class="col-sm-6">
                                    <cc1:XUIDropDownList ID="ddlOrder" runat="server" CssClass="form-control" SPParameterName="p_order" DataType="String" BindType="UItoDBOnly">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <cc1:XUIDropDownList ID="ddlSupplier" runat="server" CssClass="form-control" SPParameterName="p_supplier" BindType="Both" DataType="String" ></cc1:XUIDropDownList>
                                </div>
                            </div>                            
                        </div>
                    </div>                      
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <cc1:XUIDropDownList ID="ddlSearchBy" Width="200px" runat="server" CssClass="form-control" SPParameterName="p_search_by" DataType="String" BindType="Both">
                                        ...
                                        <asp:ListItem Value="TYPE NAME">TYPE NAME</asp:ListItem>
                                        <asp:ListItem Value="MERK NAME">MERK NAME</asp:ListItem>
                                        <asp:ListItem Value="QUOTATION">QUOTATION NO</asp:ListItem>
                                    </cc1:XUIDropDownList>
                                </div>
                                <div class="col-sm-5">
