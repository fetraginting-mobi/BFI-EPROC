<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptpurchaseorderpersupplierlist.aspx.cs" Inherits="module_report_rptpurchaseorderpersupplierlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Purchase Order Per Supplier List Report</span>
        </header>
