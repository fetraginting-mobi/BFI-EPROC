<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptgoodreceiptnotelist.aspx.cs" Inherits="module_report_rptgoodreceiptnotelist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Good Receipt Note List Report</span>
        </header>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtSearch" runat="server" SPParameterName="p_supplier_location" BindType="UItoDBOnly" CssClass="form-control" placeholder="Keywords"></asp:TextBox>  
                                </div>
                            </div>                            
                        </div>
                        <div class="col-sm-6">
