<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptpurchaserequestlist.aspx.cs" Inherits="module_report_rptpurchaserequestlist" %>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <cc1:XUIDropDownList ID="ddlSearchBy" Width="200px" runat="server" CssClass="form-control" SPParameterName="p_search_by" DataType="String" BindType="Both">
                                        <asp:ListItem Value="CODE">REQUEST NO</asp:ListItem>
