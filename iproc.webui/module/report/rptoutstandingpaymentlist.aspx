<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptoutstandingpaymentlist.aspx.cs" Inherits="module_report_rptoutstandingpaymentlist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Outstanding Payment List Report</span>
        </header>
                ...
                <div class="row">
                        <div class="col-sm-6">
                            ...
                            <label class="col-sm-3">Report Type</label>
                                <div class="col-sm-6">
                                    <cc1:XUIDropDownList ID="ddlReportType" runat="server" CssClass="form-control" DataType="String" BindType="None"  AutoPostBack= "true" >
                                        <asp:ListItem Value="TM">Termin</asp:ListItem>
                                        <asp:ListItem Value="NT">Non Termin</asp:ListItem>
                                    </cc1:XUIDropDownList>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Keywords" SPParameterName="p_supplier" BindType="UItoDBOnly"></asp:TextBox>  
                                </div>
                            </div>                            
                        </div>
                    </div> 
