<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptdocandpackagelist.aspx.cs" Inherits="module_report_rptdocandpackagelist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Document and Package List Report</span>
        </header>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="col-sm-3">Type Receipt </label>
                                <div class="col-sm-5">
                                    <cc1:XUIDropDownList ID="ddlTypeReceipt" runat="server" CssClass="form-control" SPParameterName="p_type_code" DataType="String" BindType="Both">
