<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptinventoryrequestpereffectivedate.aspx.cs" Inherits="module_report_rptinventoryrequestpereffectivedate" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Inventory Request Per Effetive Date</span>
        </header>
