<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptpenggunaanbudgetlist.aspx.cs" Inherits="module_report_rptpenggunaanbudgetlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Penggunaan Budget List Report</span>
        </header>
                    ...
                    <div class="row">
                       <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <cc1:XUIDropDownList ID="ddlUnits" runat="server" CssClass="form-control" SPParameterName="p_unit_code" BindType="Both" DataType="String" ></cc1:XUIDropDownList>  
                                </div>
                            </div>
                        </div>
                    </div>     
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <cc1:XUIDropDownList ID="ddlSearchBy" Width="200px" runat="server" CssClass="form-control" SPParameterName="p_search_by" DataType="String" BindType="Both">
                                        <asp:ListItem Value="ITEM GROUP">ITEM GROUP</asp:ListItem>
                                        <asp:ListItem Value="ITEM CODE">ITEM CODE</asp:ListItem>
                                    </cc1:XUIDropDownList>
                                </div>
                                <div class="col-sm-5">
