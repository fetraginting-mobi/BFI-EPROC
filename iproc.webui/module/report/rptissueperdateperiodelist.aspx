<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptissueperdateperiodelist.aspx.cs" Inherits="module_report_rptissueperdateperiodelist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Issue Per Date Periode List Report</span>
        </header>
