<%@ Page Title="" Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptpurchaseorderperdatebyrequestlist.aspx.cs" Inherits="module_report_rptpurchaseorderperdatebyrequestlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Purchase Order Per Date List Report</span>
        </header>
