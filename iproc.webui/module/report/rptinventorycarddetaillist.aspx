<%@ Page Language="C#" MasterPageFile="~/iproc.master" AutoEventWireup="true" CodeFile="rptinventorycarddetaillist.aspx.cs" Inherits="module_report_rptinventorycarddetaillist" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cpb" Runat="Server">
    <section class="panel">
        <header class="panel-heading">
          <span>Inventory Card Detail List Report</span>
        </header>
                ...
                <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <cc1:XUIDropDownList ID="ddlBranch" runat="server" CssClass="form-control" SPParameterName="p_branch_code" OnSelectedIndexChanged= "ddlLocation_SelectedIndexChanged" AutoPostBack= "true"  BindType="Both" DataType="String" ></cc1:XUIDropDownList>  
                                </div>
                            </div>
                        </div>
                     </div> 
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-6">
                              <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                  <ContentTemplate>
                                      <cc1:XUIDropDownList ID="ddlLocation" runat="server" CssClass="form-control" SPParameterName="p_warehouse_code"  DataType="String" BindType="UIToDBOnly"></cc1:XUIDropDownList>
                                  </ContentTemplate>
                            <Triggers>
